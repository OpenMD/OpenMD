 ...
 */
#ifndef ANALYSIS_FORTORCORRFUNC_HPP
#define ANALYSIS_FORTORCORRFUNC_HPP

#include "analysis/MultipassCorrFunc.hpp"

namespace OpenMD {

  class ForTorCorrFunc : public CrossCorrFunc<Mat3x3d> {
  public:
