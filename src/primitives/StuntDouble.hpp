...
namespace OpenMD {
  ...
  public:
     ...
     */
    bool isAtom() { return objType_ == otAtom || objType_ == otDAtom; }
     ...
     * otherwise
     */
    bool isDirectionalAtom() { return objType_ == otDAtom; }

    /**
     * Tests if this stuntDouble is a rigid body.
     * @return true if this stuntDouble is a rigid body, otherwise return false
     */
    bool isRigidBody() { return objType_ == otRigidBody; }
     ...
     * return false otherwise
     */
    bool isDirectional() { return isDirectionalAtom() || isRigidBody(); }
     ...
     */
    Vector3d getPrevPos() {
      return ((snapshotMan_->getPrevSnapshot())->*storage_)
    ...
    void setPrevPos(const Vector3d& pos) {
      ((snapshotMan_->getPrevSnapshot())->*storage_).position[localIndex_] =
          pos;
    }
    ...
    void setPos(const Vector3d& pos) {
      ...
      //((snapshotMan_->getCurrentSnapshot())->*storage_).position[localIndex_]
      //= pos;
    }
    ...
    void setPrevVel(const Vector3d& vel) {
      ((snapshotMan_->getPrevSnapshot())->*storage_).velocity[localIndex_] =
          vel;
    }
    ...
    void setPrevJ(const Vector3d& angMom) {
      ((snapshotMan_->getPrevSnapshot())->*storage_)
          .angularMomentum[localIndex_] = angMom;
    }
     ...
     *
     */
    Vector3d getCOM() { return (snapshotMan_->getCurrentSnapshot())->getCOM(); }
     ...
     */
    void setPrevQ(const Quat4d& q) { setPrevA(q); }
     ...
     * @note actual storage data is rotation matrix
     */
    void setQ(const Quat4d& q) { setA(q); }
     ...
     * @note actual storage data is rotation matrix
     */
    void setQ(const Quat4d& q, int snapshotNo) { setA(q, snapshotNo); }
    ...
    void setFrc(const Vector3d& frc, int snapshotNo) {
      ((snapshotMan_->getSnapshot(snapshotNo))->*storage_).force[localIndex_] =
          frc;
    }
    ...
    void setTrq(const Vector3d& trq, int snapshotNo) {
      ((snapshotMan_->getSnapshot(snapshotNo))->*storage_).torque[localIndex_] =
          trq;
    }
    ...
    void setPrevParticlePot(const RealType& particlePot) {
      ((snapshotMan_->getPrevSnapshot())->*storage_).particlePot[localIndex_] =
          particlePot;
    }
    ...
    void setParticlePot(const RealType& particlePot) {
      ((snapshotMan_->getCurrentSnapshot())->*storage_)
          .particlePot[localIndex_] = particlePot;
    }
    ...
    /**
     * Adds particlePot into the particlePot of this stuntDouble in specified
     * snapshot
     *
    ...
    void setPrevFlucQPos(RealType charge) {
      ((snapshotMan_->getPrevSnapshot())->*storage_).flucQPos[localIndex_] =
          charge;
    }
    ...
    void setFlucQPos(RealType charge) {
      ((snapshotMan_->getCurrentSnapshot())->*storage_).flucQPos[localIndex_] =
          charge;
    }
    ...
    void setFlucQPos(RealType charge, int snapshotNo) {
      ((snapshotMan_->getSnapshot(snapshotNo))->*storage_)
          .flucQPos[localIndex_] = charge;
    }

    /**
     * Adds fluctuating charge into the previous fluctuating charge of this
     * stuntDouble
     * @param charge  new fluctuating charge
     * @see #getFlucQPos
     */
    ...
    /**
     * Adds fluctuating charge into the current fluctuating charge of this
     * stuntDouble
     * @param charge  new fluctuating charge
     */
    ...
    /**
     * Adds fluctuating charge into the fluctuating charge of this stuntDouble
     * in specified snapshot
    ...
    void setPrevFlucQVel(RealType cvel) {
      ((snapshotMan_->getPrevSnapshot())->*storage_).flucQVel[localIndex_] =
          cvel;
    }
    ...
    void setFlucQVel(RealType cvel) {
      ((snapshotMan_->getCurrentSnapshot())->*storage_).flucQVel[localIndex_] =
          cvel;
    }
    ...
    void setFlucQVel(RealType cvel, int snapshotNo) {
      ((snapshotMan_->getSnapshot(snapshotNo))->*storage_)
          .flucQVel[localIndex_] = cvel;
    }

    /**
     * Adds charge velocity into the previous charge velocity of this
     * stuntDouble
     * @param cvel  new charge velocity
     * @see #getFlucQVel
     */
    ...
    /**
     * Adds charge velocity into the charge velocity of this stuntDouble in
     * specified snapshot
    ...
    void setPrevFlucQFrc(RealType cfrc) {
      ((snapshotMan_->getPrevSnapshot())->*storage_).flucQFrc[localIndex_] =
          cfrc;
    }
    ...
    /**
     * Adds charge force into the charge force of this stuntDouble in specified
     * snapshot
     * @param cfrc charge force to be added
     * @param snapshotNo
     * @see #getFlucQFrc
    ...
    void setPrevElectricField(const Vector3d& eField) {
      ((snapshotMan_->getPrevSnapshot())->*storage_)
          .electricField[localIndex_] = eField;
    }
    ...
    /**
     * Adds electric field into the electric field of this stuntDouble in
     * specified snapshot
     *
    ...
    void setPrevSitePotential(RealType spot) {
      ((snapshotMan_->getPrevSnapshot())->*storage_)
          .sitePotential[localIndex_] = spot;
    }
    ...
    /**
     * Adds site potential into the site potential of this stuntDouble in
     * specified snapshot
     * @param spot site potential to be added
     * @param snapshotNo
     * @see #getSitePotential
    ...
    void setPrevDensity(RealType dens) {
      ((snapshotMan_->getPrevSnapshot())->*storage_).density[localIndex_] =
          dens;
    }
    ...
    void setDensity(RealType dens) {
      ((snapshotMan_->getCurrentSnapshot())->*storage_).density[localIndex_] =
          dens;
    }
     ...
     * @see #isLinear
     */
    int linearAxis() { return linearAxis_; }

    /** Returns the mass of this stuntDouble */
    RealType getMass() { return mass_; }

    /**
     * Sets the mass of this stuntdoulbe
     * @param mass the mass to be set
     */
    void setMass(RealType mass) { mass_ = mass; }
    ...
    Vector3d lab2Body(const Vector3d& v, int frame) { return getA(frame) * v; }
