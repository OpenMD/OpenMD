...
#include "types/AtomTypeProperties.h"    
  ...
  is_SuttonChen = (atp%is_SuttonChen .ne. 0)
  is_MEAM = (atp%is_MEAM .ne. 0)
  ...
  call new_atype(ident, is_Directional, is_LennardJones, is_Electrostatic, &
       ...
       is_GayBerne, is_EAM, is_Shape, is_FLARB, is_SuttonChen, is_MEAM,status)
