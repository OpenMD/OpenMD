/*
  ...
  gengetopt -i nanorodBuilder.ggo -F nanorodBuilderCmd -u 
...
const char *gengetopt_args_info_purpose = "Builds spherically-capped random or core-shell nanorods and outputs an OpenMD \nstartup file";
