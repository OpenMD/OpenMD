/*
  ...
  /opt/local/bin/gengetopt -C --input=nanorodBuilder.ggo --no-handle-error --include-getopt --show-required --unamed-opts --file-name=nanorodBuilderCmd --c-extension=cpp --header-extension=hpp
