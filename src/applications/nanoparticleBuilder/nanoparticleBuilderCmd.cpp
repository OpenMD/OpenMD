/*
  ...
  /opt/local/bin/gengetopt -C --input=nanoparticleBuilder.ggo --no-handle-error --include-getopt --show-required --unamed-opts --file-name=nanoparticleBuilderCmd --c-extension=cpp --header-extension=hpp
...
const char *gengetopt_args_info_help[] = {
  ...
  "      --radius=DOUBLE           Nanoparticle radius in Angstroms (mandatory)",
