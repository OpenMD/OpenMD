/*
  ...
  /opt/local/bin/gengetopt -C --input=icosahedralBuilder.ggo --no-handle-error --include-getopt --show-required --unamed-opts --file-name=icosahedralBuilderCmd --c-extension=cpp --header-extension=hpp
...
const char *gengetopt_args_info_help[] = {
  ...
  "  -n, --shells=INT              Nanoparticle shells (mandatory)",
  ...
  while (1)
    {
      ...
      c = custom_getopt_long (argc, argv, "hVo:n:d:c:t:p:", long_options, &option_index);
