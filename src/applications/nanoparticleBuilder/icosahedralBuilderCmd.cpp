/*
  ...
  gengetopt --no-handle-error --include-getopt --show-required --unamed-opts --file-name=icosahedralBuilderCmd --c-extension=cpp --header-extension=hpp
...
const char *gengetopt_args_info_help[] = {
  ...
  "      --cuboctahedron           Create a regular Cuboctahedron (requires\n                                  lattice)",
  ...
  while (1)
    {
      ...
      c = custom_getopt_long (argc, argv, "hVo:n:d:l:c:t:p:u:", long_options, &option_index);
      ...
      switch (c)
        ...
        case 't':	/* Number of atoms along twin boundary (Decahedron only).  */
          ...
          break;
        case 'p':	/* Number of truncated planes (Curling-stone Decahedra and Truncated Cubes only).  */
        ...
        case 'u':	/* Number of unit cell (Cuboctahedron and Truncated Cube only).  */
          ...
          if (update_arg( (void *)&(args_info->unitCells_arg), 
               &(args_info->unitCells_orig), &(args_info->unitCells_given),
              &(local_args_info.unitCells_given), optarg, 0, 0, ARG_INT,
              check_ambiguity, override, 0, 0,
              "unitCells", 'u',
              additional_error))
            goto failure;
        ...
        case 0:	/* Long option with no short option */
          ...
          else if (strcmp (long_options[option_index].name, "cuboctahedron") == 0)
          {
            ...
            if (update_arg( 0 , 
                 0 , &(args_info->cuboctahedron_given),
                &(local_args_info.cuboctahedron_given), optarg, 0, 0, ARG_NO,
                check_ambiguity, override, 0, 0,
                "cuboctahedron", '-',
                additional_error))
              goto failure;
          ...
          else if (strcmp (long_options[option_index].name, "truncatedCube") == 0)
          {
            ...
            if (update_arg( 0 , 
                 0 , &(args_info->truncatedCube_given),
                &(local_args_info.truncatedCube_given), optarg, 0, 0, ARG_NO,
                check_ambiguity, override, 0, 0,
                "truncatedCube", '-',
                additional_error))
              goto failure;
