/*
  ...
  --file-name=icosahedralBuilderCmd --c-extension=cpp --header-extension=hpp
...
const char* gengetopt_args_info_purpose =
    ...
    "skeletal "
    "OpenMD file to specify the component that is to\nbe placed on the "
    "lattice. The "
    "total number of placed molecules will be\nshown at the top of the "
    "configuration "
    "file that is generated, and that\nnumber may not match the original "
    "meta-data file, "
...
const char* gengetopt_args_info_help[] = {
    ...
    "  -d, --latticeConstant=DOUBLE  Lattice spacing in Angstroms for cubic "
    "lattice.",
    ...
    "          "
    "                    (Decahedron only)",
    "  -t, --twinAtoms=INT           Number of atoms along twin boundary "
    "(Decahedron\n   "
    "                               only)",
    "  -p, --truncatedPlanes=INT     Number of truncated planes "
    "(Curling-stone\n         "
    "                         Decahedra and Truncated Cubes only)",
    "  -u, --unitCells=INT           Number of unit cell (Cuboctahedron and\n  "
    "          "
    "                      Truncated Cube only)",
    ...
    "      --cuboctahedron           Create a regular Cuboctahedron "
    "(requires\n          "
    "                        lattice)",
    "      --truncatedCube           Create a Truncated Cube (requires "
    "lattice)",
    0};
...
int cmdline_parser_dump(FILE* outfile, struct gengetopt_args_info* args_info) {
  ...
  if (args_info->latticeConstant_given)
    write_into_file(outfile, "latticeConstant", args_info->latticeConstant_orig,
                    0);
  if (args_info->lattice_given)
    write_into_file(outfile, "lattice", args_info->lattice_orig,
                    cmdline_parser_lattice_values);
  ...
  if (args_info->truncatedPlanes_given)
    write_into_file(outfile, "truncatedPlanes", args_info->truncatedPlanes_orig,
                    0);
  if (args_info->unitCells_given)
    write_into_file(outfile, "unitCells", args_info->unitCells_orig, 0);
  if (args_info->ico_given) write_into_file(outfile, "ico", 0, 0);
  if (args_info->deca_given) write_into_file(outfile, "deca", 0, 0);
  if (args_info->ino_given) write_into_file(outfile, "ino", 0, 0);
  if (args_info->marks_given) write_into_file(outfile, "marks", 0, 0);
  if (args_info->stone_given) write_into_file(outfile, "stone", 0, 0);
  if (args_info->cuboctahedron_given)
    write_into_file(outfile, "cuboctahedron", 0, 0);
  if (args_info->truncatedCube_given)
    write_into_file(outfile, "truncatedCube", 0, 0);
...
int cmdline_parser_required2(struct gengetopt_args_info* args_info,
  ...
  if (args_info->clusterShape_group_counter == 0) {
    fprintf(
        ...
        prog_name, args_info->clusterShape_group_counter,
        (additional_error ? additional_error : ""));
    error_occurred = 1;
  }
...
int cmdline_parser_internal(int argc, char** argv,
  ...
  while (1) {
    ...
    c = custom_getopt_long(argc, argv, "hVo:n:d:l:c:t:p:u:", long_options,
                           &option_index);
  ...
  if (args_info->clusterShape_group_counter > 1) {
    fprintf(
        stderr,
        "%s: %d options of group clusterShape were given. One is required%s.\n",
        argv[0], args_info->clusterShape_group_counter,
        (additional_error ? additional_error : ""));
    error_occurred = 1;
  }
