...
Example:
   omd-solvator-slab -u solute.omd -v solvent.omd -o combined.omd

"""

__author__ = "Charles Vardeman (cvardema@nd.edu) - original omd-solvator file. Changes here made by Sydney Shavalier (sshavali@nd.edu)"
