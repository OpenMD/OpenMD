/*
  ...
  --file-name=elasticConstantsCmd --c-extension=cpp --header-extension=hpp
...
const char *gengetopt_args_info_purpose =
    "Computes the general elastic constants that relate stress and strain for "
    "a\ngiven "
    "input configuration";

const char *gengetopt_args_info_usage =
    "Usage: elasticConstants [-h|--help] [-V|--version] "
    "[-iSTRING|--input=STRING]\n      "
...
const char *gengetopt_args_info_help[] = {
    ...
    "  -b, --box            Optimize box geometry before performing "
    "calculation\n        "
    "                 (default=off)",
...
const char *cmdline_parser_method_values[] = {
    "energy", "stress", 0}; /*< Possible values for method. */
...
int cmdline_parser_dump(FILE *outfile, struct gengetopt_args_info *args_info) {
  ...
  if (args_info->box_given) write_into_file(outfile, "box", 0, 0);
  if (args_info->method_given)
    write_into_file(outfile, "method", args_info->method_orig,
                    cmdline_parser_method_values);
...
int cmdline_parser_internal(int argc, char **argv,
  ...
  while (1) {
    ...
    static struct option long_options[] = {
        ...
        {"input", 1, NULL, 'i'},  {"box", 0, NULL, 'b'},
        {"method", 1, NULL, 'm'}, {"npoints", 1, NULL, 'n'},
        {"delta", 1, NULL, 'd'},  {0, 0, 0, 0}};
    ...
    c = custom_getopt_long(argc, argv, "hVi:bm:n:d:", long_options,
                           &option_index);
    ...
    switch (c) {
      ...
      case 'b': /* Optimize box geometry before performing calculation.  */
        ...
        if (update_arg((void *)&(args_info->box_flag), 0,
                       &(args_info->box_given), &(local_args_info.box_given),
                       optarg, 0, 0, ARG_FLAG, check_ambiguity, override, 1, 0,
                       "box", 'b', additional_error))
          goto failure;
      ...
      case 'm': /* Calculation Method.  */
        ...
        if (update_arg((void *)&(args_info->method_arg),
                       ...
                       &(local_args_info.method_given), optarg,
                       cmdline_parser_method_values, 0, ARG_STRING,
                       check_ambiguity, override, 0, 0, "method", 'm',
                       additional_error))
          goto failure;
...
stress-strain relationship.  */
        ...
        if (update_arg((void *)&(args_info->npoints_arg),
                       ...
                       &(local_args_info.npoints_given), optarg, 0, "25",
                       ARG_INT, check_ambiguity, override, 0, 0, "npoints", 'n',
                       additional_error))
          goto failure;
      ...
      case 'd': /* size of relative volume changes for strains.  */
        ...
        if (update_arg((void *)&(args_info->delta_arg),
                       ...
                       check_ambiguity, override, 0, 0, "delta", 'd',
                       additional_error))
          goto failure;
