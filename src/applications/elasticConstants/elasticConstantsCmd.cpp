...
int cmdline_parser_internal(int argc, char** argv,
  ...
  while (1) {
    ...
    case 'm': /* Calculation Method.  */
      ...
      if (update_arg(
              (void*)&(args_info->method_arg), &(args_info->method_orig),
              &(args_info->method_given), &(local_args_info.method_given),
              optarg, cmdline_parser_method_values, 0, ARG_STRING,
              check_ambiguity, override, 0, 0, "method", 'm', additional_error))
        goto failure;
...
stress-strain relationship.  */
      ...
      if (update_arg((void*)&(args_info->npoints_arg),
                     ...
                     check_ambiguity, override, 0, 0, "npoints", 'n',
                     additional_error))
        goto failure;
    ...
    case 'd': /* size of relative volume changes for strains.  */
      ...
      if (update_arg((void*)&(args_info->delta_arg), &(args_info->delta_orig),
                     &(args_info->delta_given), &(local_args_info.delta_given),
                     optarg, 0, 0, ARG_DOUBLE, check_ambiguity, override, 0, 0,
                     "delta", 'd', additional_error))
        goto failure;
