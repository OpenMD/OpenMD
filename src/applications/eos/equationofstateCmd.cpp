/*
  ...
  gengetopt --no-handle-error --include-getopt --show-required --unamed-opts --file-name=equationofstateCmd --c-extension=cpp --header-extension=hpp
  ...
  while (1)
    {
      ...
      c = custom_getopt_long (argc, argv, "hVi:o:s:e:n:", long_options, &option_index);
