/*
  ...
  --file-name=equationofstateCmd --c-extension=cpp --header-extension=hpp
...
const char* gengetopt_args_info_purpose =
    "This takes omd file and generates equation of state of "
    "crystal.\nExample:\n  "
...
int cmdline_parser_internal(int argc, char** argv,
  ...
  while (1) {
    ...
    static struct option long_options[] = {
        ...
        {"initial", 1, NULL, 's'}, {"final", 1, NULL, 'e'},
        {"number", 1, NULL, 'n'},  {0, 0, 0, 0}};
    ...
    c = custom_getopt_long(argc, argv, "hVi:o:s:e:n:", long_options,
                           &option_index);
    ...
    case 'i': /* use specified input (.omd) file.  */
    ...
    case 's': /* initial affine scale.  */
      ...
      if (update_arg((void*)&(args_info->initial_arg),
                     ...
                     &(local_args_info.initial_given), optarg, 0, "0.5",
                     ARG_DOUBLE, check_ambiguity, override, 0, 0, "initial",
                     's', additional_error))
        goto failure;
    ...
    case 'e': /* final affine scale.  */
      ...
      if (update_arg((void*)&(args_info->final_arg), &(args_info->final_orig),
                     &(args_info->final_given), &(local_args_info.final_given),
                     optarg, 0, "1.5", ARG_DOUBLE, check_ambiguity, override, 0,
                     0, "final", 'e', additional_error))
        goto failure;

      break;
    case 'n': /* number of data points.  */

      if (update_arg((void*)&(args_info->number_arg), &(args_info->number_orig),
                     &(args_info->number_given),
                     &(local_args_info.number_given), optarg, 0, "50", ARG_INT,
                     check_ambiguity, override, 0, 0, "number", 'n',
                     additional_error))
        goto failure;
