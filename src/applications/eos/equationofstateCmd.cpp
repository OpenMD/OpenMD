    ...
    switch (c) {
      ...
      case 'e': /* final affine scale.  */
        ...
        if (update_arg((void *)&(args_info->final_arg),
                       ...
                       &(local_args_info.final_given), optarg, 0, "1.5",
                       ARG_DOUBLE, check_ambiguity, override, 0, 0, "final",
                       'e', additional_error))
          goto failure;
      ...
      case 'n': /* number of data points.  */
        ...
        if (update_arg((void *)&(args_info->number_arg),
                       ...
                       &(local_args_info.number_given), optarg, 0, "50",
                       ARG_INT, check_ambiguity, override, 0, 0, "number", 'n',
                       additional_error))
          goto failure;
