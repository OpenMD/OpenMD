...
#ifndef EQUATIONOFSTATECMD_H
#define EQUATIONOFSTATECMD_H
...
#define CMDLINE_PARSER_PACKAGE "equationofstate"
#endif

#ifndef CMDLINE_PARSER_PACKAGE_NAME
/** @brief the complete program name (used for help and version) */
#define CMDLINE_PARSER_PACKAGE_NAME "equationofstate"
#endif
...
struct gengetopt_args_info {
  ...
  char* input_arg;  /**< @brief use specified input (.omd) file.  */
  char* input_orig; /**< @brief use specified input (.omd) file original value
                       given at command line.  */
  const char* input_help; /**< @brief use specified input (.omd) file help
                             description.  */
  ...
  char* initial_orig; /**< @brief initial affine scale original value given at
                         command line.  */
  const char*
      initial_help;       /**< @brief initial affine scale help description.  */
  double final_arg;       /**< @brief final affine scale (default='1.5').  */
  char* final_orig;       /**< @brief final affine scale original value given at
                             command line.  */
  const char* final_help; /**< @brief final affine scale help description.  */
  int number_arg;         /**< @brief number of data points (default='50').  */
  char* number_orig; /**< @brief number of data points original value given at
                        command line.  */
  const char*
      number_help; /**< @brief number of data points help description.  */
