...
struct gengetopt_args_info
{
  ...
  char * input_orig;	/**< @brief use specified input (.omd) file original value given at command line.  */
  const char *input_help; /**< @brief use specified input (.omd) file help description.  */
