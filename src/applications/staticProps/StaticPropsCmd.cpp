/*
  ...
  gengetopt --no-handle-error --include-getopt --show-required --unamed-opts
  --file-name=StaticPropsCmd --c-extension=cpp --header-extension=hpp
...
const char* gengetopt_args_info_purpose =
    ...
    "property "
    "that can be computed is the pair\ndistribution function between atoms of "
    "type A and "
    "other atoms of type\nB, gAB(r).\n\nExample:\n   StaticProps -i tp4.dump "
    "--gofr "
    "--sele1=\"select O*\" --sele2=\"select O*\"\n\nThis command computes the "
...
const char* gengetopt_args_info_help[] = {
    ...
    "  -r, --nrbins=INT              number of radial bins (usually "
    "duplicates\n         "
    "                         functionality of nbins)  (default=`100')",
    "  -a, --nanglebins=INT          number of bins for cos(angle)  "
    "(default=`50')",
    "  -c, --rcut=DOUBLE             cutoff radius (rcut)",
    "      --OOcut=DOUBLE            Oxygen-Oxygen cutoff radius (angstroms)\n "
    "          "
    "                       (default=`3.5')",
    "      --thetacut=DOUBLE         HOO cutoff angle (degrees)  "
    "(default=`30')",
    "      --OHcut=DOUBLE            Oxygen-Hydrogen cutoff radius "
    "(angstroms)\n         "
    "                         (default=`2.45')",
    "      --dz=DOUBLE               slab width (dz)",
    "      --length=DOUBLE           maximum length (Defaults to 1/2 smallest "
    "length\n   "
    "                               of first frame)",
    "      --zlength=DOUBLE          maximum length (Defaults to 1/2 smallest "
    "length\n   "
    "                               of first frame)",
    "  -z, --zoffset=DOUBLE          Where to set the zero for the "
    "slab_density\n        "
    ...
    "reference "
    "(use and only use with --gxyz)",
    "      --comsele=selection script\n                                select "
    "stunt "
    "doubles for center-of-mass\n                                  reference "
    "point",
    "      --seleoffset=INT          global index offset for a second object "
    "(used\n     "
    "                             to define a vector between sites in "
    "molecule)",
    "      --seleoffset2=INT         global index offset for a third object "
    "(used to\n   "
    ...
    "      --privilegedAxis=ENUM     which axis is special for spatial "
    "analysis\n        "
    "                          (default = z axis)  (possible values=\"x\",\n   "
    "          "
    "                     \"y\", \"z\" default=`z')",
    "      --privilegedAxis2=ENUM    which axis is special for spatial "
    "analysis\n        "
    ...
    "      --dipoleX=DOUBLE          X-component of the dipole with respect to "
    "body\n    "
    "                              frame",
    "      --dipoleY=DOUBLE          Y-component of the dipole with respect to "
    "body\n    "
    "                              frame",
    "      --dipoleZ=DOUBLE          Z-component of the dipole with respect to "
    "body\n    "
    "                              frame",
    "      --v_radius=DOUBLE         VanderWaals radiius for fictious atoms "
    "used in\n    "
    "                              model eg. M site in TIP4P-FQ water model",
    "      --gen_xyz                 generats xyz file  (default=off)",
    "      --atom_name=selection script\n                                name "
    "of atom "
    "for with average charge to be\n                                  "
    "generated",
    "\n Group: staticProps\n   an option of this group is required",
    "      --bo                      bond order parameter (--rcut must be "
    "specified)",
    "      --ior                     icosahedral bond order parameter as a "
    "function\n    "
    "                              of radius (--rcut must be specified)",
    "      --for                     FCC bond order parameter as a function "
    "of\n         "
    "                         radius (--rcut must be specified)",
    "      --bad                     N(theta) bond angle density within "
    "(--rcut must\n   "
    "                               be specified)",
    "      --count                   count of molecules matching selection "
    "criteria\n    "
    ...
    "      --gxyz                    g(x, y, z)",
    "      --twodgofr                2D g(r) (Slab width --dz must be "
    "specified)",
    "  -p, --p2                      p2 order parameter (--sele1 must be "
    "specified,\n    "
    "                              --sele2 is optional)",
    "      --rp2                     rp2 order parameter (--sele1 and --sele2 "
    "must\n     "
    "                             be specified)",
    "  -s, --scd                     scd order parameter (either --sele1, "
    "--sele2,\n     "
    ...
    "      --p_angle                 p(cos(theta)) (--sele1 must be "
    "specified,\n         "
    "                         --sele2 is optional)",
    "      --hxy                     hxy",
    "      --rho_r                   rho(R)",
    ...
    "          "
    "                       parameter Qk(z)",
    "      --tet_param_dens          computes density of the tetrahedrality "
    "order\n      "
    "                            parameter Qk",
    "      --tet_param_xyz           volume-resolved tetrahedrality order "
    "parameter\n    "
    "                              Qk(x,y,z).  (voxelSize, rcut, and "
    "gaussWidth\n        "
    "                          must be specified)",
    "      --rnemdz                  slab-resolved RNEMD statistics "
    "(temperature,\n      "
    "                            density, velocity)",
    "      --rnemdr                  shell-resolved RNEMD statistics "
    "(temperature,\n     "
    "                             density, angular velocity)",
    "      --rnemdrt                 shell and angle-resolved RNEMD "
    "statistics\n         "
    "                         (temperature, density, angular velocity)",
    "      --nitrile                 electrostatic potential to frequency map "
    "based\n    "
    "                              on the Cho nitrile fits",
    "  -m, --multipole               average multipole moments contained "
    "within\n        "
    "                          cutoff spheres as a function of radius",
    "      --surfDiffusion           X, Y, and R (surface diffusion if Z "
    "exposed and\n   "
    "                               bulk immobile) diffusion",
    "      --cn                      Coordination Number Distribution",
    "      --scn                     Secondary Coordination Number "
    "Distribution",
    "      --gcn                     Generalized Coordination Number "
    "Distribution",
    "      --hbond                   Hydrogen Bonding statistics using "
    "geometric\n       "
    "                           criteria (rcut and thetacut must be\n          "
    "          "
    "              specified)",
    "      --potDiff                 potential energy difference when charge "
    "on\n        "
    ...
    "      --velocityZ               computes an average two-dimensional "
    "velocity\n      "
    "                            map",
    "  -D, --eam_density             computes an average eam density profile "
    "of the\n    "
    "                              selected atom",
    "  -q, --net_charge              computes an average charge profile of "
    "the\n         "
    "                         selected atom",
    "  -J, --current_density         computes the current density for the "
    "selected\n     "
    "                             atom",
    "      --chargez                 computes the charge distribution along "
    "selected\n   "
    "                               axis and selected atom",
    "      --charge_density_z        computes the continuous charge "
    "distribution\n       "
    "                           along selected axis and selected atom",
    "      --countz                  computes the number of selected atoms  "
    "along\n      "
    "                            selected axis",
    "  -M, --momentum_distribution   computes the momentum distribution for "
    "the\n        "
    "                          selected atom",
    "  -S, --dipole_orientation      spatially-resolved dipole order parameter "
    "S(z),\n   "
    "                               S = (3 Cos^2\\theta - 1)/2",
    "      --order_prob              probability of order parameter for "
    "given\n          "
    "                        selection",
    0};
...
int cmdline_parser_dump(FILE* outfile, struct gengetopt_args_info* args_info) {
  ...
  if (args_info->privilegedAxis_given)
    write_into_file(outfile, "privilegedAxis", args_info->privilegedAxis_orig,
                    cmdline_parser_privilegedAxis_values);
  if (args_info->privilegedAxis2_given)
    write_into_file(outfile, "privilegedAxis2", args_info->privilegedAxis2_orig,
                    cmdline_parser_privilegedAxis2_values);
  if (args_info->momentum_given)
    write_into_file(outfile, "momentum", args_info->momentum_orig,
                    cmdline_parser_momentum_values);
  if (args_info->component_given)
    write_into_file(outfile, "component", args_info->component_orig,
                    cmdline_parser_component_values);
  ...
  if (args_info->gen_xyz_given) write_into_file(outfile, "gen_xyz", 0, 0);
  if (args_info->atom_name_given)
    write_into_file(outfile, "atom_name", args_info->atom_name_orig, 0);
  if (args_info->bo_given) write_into_file(outfile, "bo", 0, 0);
  if (args_info->ior_given) write_into_file(outfile, "ior", 0, 0);
  if (args_info->for_given) write_into_file(outfile, "for", 0, 0);
  if (args_info->bad_given) write_into_file(outfile, "bad", 0, 0);
  if (args_info->count_given) write_into_file(outfile, "count", 0, 0);
  if (args_info->gofr_given) write_into_file(outfile, "gofr", 0, 0);
  if (args_info->gofz_given) write_into_file(outfile, "gofz", 0, 0);
  if (args_info->r_theta_given) write_into_file(outfile, "r_theta", 0, 0);
  if (args_info->r_omega_given) write_into_file(outfile, "r_omega", 0, 0);
  if (args_info->r_z_given) write_into_file(outfile, "r_z", 0, 0);
  ...
  if (args_info->gxyz_given) write_into_file(outfile, "gxyz", 0, 0);
  if (args_info->twodgofr_given) write_into_file(outfile, "twodgofr", 0, 0);
  if (args_info->p2_given) write_into_file(outfile, "p2", 0, 0);
  if (args_info->rp2_given) write_into_file(outfile, "rp2", 0, 0);
  if (args_info->scd_given) write_into_file(outfile, "scd", 0, 0);
  if (args_info->density_given) write_into_file(outfile, "density", 0, 0);
  ...
  if (args_info->p_angle_given) write_into_file(outfile, "p_angle", 0, 0);
  if (args_info->hxy_given) write_into_file(outfile, "hxy", 0, 0);
  if (args_info->rho_r_given) write_into_file(outfile, "rho_r", 0, 0);
  if (args_info->angle_r_given) write_into_file(outfile, "angle_r", 0, 0);
  if (args_info->hullvol_given) write_into_file(outfile, "hullvol", 0, 0);
  if (args_info->rodlength_given) write_into_file(outfile, "rodlength", 0, 0);
  if (args_info->tet_param_given) write_into_file(outfile, "tet_param", 0, 0);
  ...
  if (args_info->rnemdz_given) write_into_file(outfile, "rnemdz", 0, 0);
  if (args_info->rnemdr_given) write_into_file(outfile, "rnemdr", 0, 0);
  if (args_info->rnemdrt_given) write_into_file(outfile, "rnemdrt", 0, 0);
  if (args_info->nitrile_given) write_into_file(outfile, "nitrile", 0, 0);
  if (args_info->multipole_given) write_into_file(outfile, "multipole", 0, 0);
  if (args_info->surfDiffusion_given)
    write_into_file(outfile, "surfDiffusion", 0, 0);
  if (args_info->cn_given) write_into_file(outfile, "cn", 0, 0);
  if (args_info->scn_given) write_into_file(outfile, "scn", 0, 0);
  if (args_info->gcn_given) write_into_file(outfile, "gcn", 0, 0);
  if (args_info->hbond_given) write_into_file(outfile, "hbond", 0, 0);
  if (args_info->potDiff_given) write_into_file(outfile, "potDiff", 0, 0);
  if (args_info->tet_hb_given) write_into_file(outfile, "tet_hb", 0, 0);
  if (args_info->kirkwood_given) write_into_file(outfile, "kirkwood", 0, 0);
  if (args_info->kirkwoodQ_given) write_into_file(outfile, "kirkwoodQ", 0, 0);
  ...
  if (args_info->velocityZ_given) write_into_file(outfile, "velocityZ", 0, 0);
  if (args_info->eam_density_given)
    write_into_file(outfile, "eam_density", 0, 0);
  if (args_info->net_charge_given) write_into_file(outfile, "net_charge", 0, 0);
  if (args_info->current_density_given)
    write_into_file(outfile, "current_density", 0, 0);
  if (args_info->chargez_given) write_into_file(outfile, "chargez", 0, 0);
  if (args_info->charge_density_z_given)
    write_into_file(outfile, "charge_density_z", 0, 0);
  if (args_info->countz_given) write_into_file(outfile, "countz", 0, 0);
  ...
  if (args_info->order_prob_given) write_into_file(outfile, "order_prob", 0, 0);
...
int cmdline_parser_required2(struct gengetopt_args_info* args_info,
  ...
  if (args_info->staticProps_group_counter == 0) {
    fprintf(
        ...
        prog_name, args_info->staticProps_group_counter,
        (additional_error ? additional_error : ""));
    error_occurred = 1;
  }
 ...
 *
 * Otherwise, `custom_optind' communicates from one call to the next how much of
...
static int shuffle_argv(int argc, char* const* argv,
   ...
   */
  if (d->last_nonopt > d->custom_optind) d->last_nonopt = d->custom_optind;
  if (d->first_nonopt > d->custom_optind) d->first_nonopt = d->custom_optind;
  /*
  ...
  if (d->custom_optind == argc) {
     ...
     */
    if (d->first_nonopt != d->last_nonopt) d->custom_optind = d->first_nonopt;
    return -1;
  }
  /*
...
static int check_short_opt(int argc, char* const* argv, const char* optstring,
  ...
  if (!temp || c == ':') {
    if (print_errors) fprintf(stderr, "%s: invalid option -- %c\n", argv[0], c);
...
int cmdline_parser_internal(int argc, char** argv,
  ...
  while (1) {
    ...
    c = custom_getopt_long(argc, argv, "hVi:o:n:b:x:y:r:a:c:z:v:gpsdQmkDqJMS",
  ...
  if (args_info->staticProps_group_counter > 1) {
    fprintf(
        stderr,
        "%s: %d options of group staticProps were given. One is required%s.\n",
        argv[0], args_info->staticProps_group_counter,
        (additional_error ? additional_error : ""));
    error_occurred = 1;
  }
