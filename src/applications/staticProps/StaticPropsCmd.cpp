...
const char *gengetopt_args_info_help[] = {
  ...
  "      --binWidth=DOUBLE         width of radial bins in angstroms\n                                  (default=`1.0')",
  ...
  "      --count                   count of objects matching selection criteria\n                                  (and associated statistics)",
  "      --mcount                  count of molecules matching selection criteria\n                                  (and associated statistics)",
  "  -g, --gofr                    g(r)",
  "      --gofz                    g(z)",
  ...
  "      --massdensityz            computes the mass density of the selection\n                                  along selected axis",
  "      --massdensityr            computes the mass density of the selection as a\n                                  function of the radius from the center of\n                                  mass",
...
void clear_given (struct gengetopt_args_info *args_info)
{
  ...
  args_info->massdensityz_given = 0 ;
  args_info->massdensityr_given = 0 ;
...
void init_args_info(struct gengetopt_args_info *args_info)
{
  ...
  args_info->nanglebins_help = gengetopt_args_info_help[11] ;
  args_info->rcut_help = gengetopt_args_info_help[12] ;
  args_info->OOcut_help = gengetopt_args_info_help[13] ;
  args_info->thetacut_help = gengetopt_args_info_help[14] ;
  args_info->OHcut_help = gengetopt_args_info_help[15] ;
  args_info->dz_help = gengetopt_args_info_help[16] ;
  args_info->length_help = gengetopt_args_info_help[17] ;
  args_info->zlength_help = gengetopt_args_info_help[18] ;
  args_info->zoffset_help = gengetopt_args_info_help[19] ;
  args_info->sele1_help = gengetopt_args_info_help[20] ;
  args_info->sele2_help = gengetopt_args_info_help[21] ;
  args_info->sele3_help = gengetopt_args_info_help[22] ;
  args_info->refsele_help = gengetopt_args_info_help[23] ;
  args_info->comsele_help = gengetopt_args_info_help[24] ;
  args_info->seleoffset_help = gengetopt_args_info_help[25] ;
  args_info->seleoffset2_help = gengetopt_args_info_help[26] ;
  args_info->molname_help = gengetopt_args_info_help[27] ;
  args_info->begin_help = gengetopt_args_info_help[28] ;
  args_info->end_help = gengetopt_args_info_help[29] ;
  args_info->radius_help = gengetopt_args_info_help[30] ;
  args_info->voxelSize_help = gengetopt_args_info_help[31] ;
  args_info->gaussWidth_help = gengetopt_args_info_help[32] ;
  args_info->privilegedAxis_help = gengetopt_args_info_help[33] ;
  args_info->privilegedAxis2_help = gengetopt_args_info_help[34] ;
  args_info->momentum_help = gengetopt_args_info_help[35] ;
  args_info->component_help = gengetopt_args_info_help[36] ;
  args_info->dipoleX_help = gengetopt_args_info_help[37] ;
  args_info->dipoleY_help = gengetopt_args_info_help[38] ;
  args_info->dipoleZ_help = gengetopt_args_info_help[39] ;
  args_info->v_radius_help = gengetopt_args_info_help[40] ;
  args_info->gen_xyz_help = gengetopt_args_info_help[41] ;
  args_info->atom_name_help = gengetopt_args_info_help[42] ;
  args_info->bo_help = gengetopt_args_info_help[44] ;
  args_info->ior_help = gengetopt_args_info_help[45] ;
  args_info->for_help = gengetopt_args_info_help[46] ;
  args_info->bad_help = gengetopt_args_info_help[47] ;
  args_info->count_help = gengetopt_args_info_help[48] ;
  args_info->mcount_help = gengetopt_args_info_help[49] ;
  args_info->gofr_help = gengetopt_args_info_help[50] ;
  args_info->gofz_help = gengetopt_args_info_help[51] ;
  args_info->r_theta_help = gengetopt_args_info_help[52] ;
  args_info->r_omega_help = gengetopt_args_info_help[53] ;
  args_info->r_z_help = gengetopt_args_info_help[54] ;
  args_info->theta_omega_help = gengetopt_args_info_help[55] ;
  args_info->r_theta_omega_help = gengetopt_args_info_help[56] ;
  args_info->gxyz_help = gengetopt_args_info_help[57] ;
  args_info->twodgofr_help = gengetopt_args_info_help[58] ;
  args_info->kirkwood_buff_help = gengetopt_args_info_help[59] ;
  args_info->p2_help = gengetopt_args_info_help[60] ;
  args_info->p2r_help = gengetopt_args_info_help[61] ;
  args_info->rp2_help = gengetopt_args_info_help[62] ;
  args_info->scd_help = gengetopt_args_info_help[63] ;
  args_info->density_help = gengetopt_args_info_help[64] ;
  args_info->slab_density_help = gengetopt_args_info_help[65] ;
  args_info->pipe_density_help = gengetopt_args_info_help[66] ;
  args_info->p_angle_help = gengetopt_args_info_help[67] ;
  args_info->hxy_help = gengetopt_args_info_help[68] ;
  args_info->rho_r_help = gengetopt_args_info_help[69] ;
  args_info->angle_r_help = gengetopt_args_info_help[70] ;
  args_info->hullvol_help = gengetopt_args_info_help[71] ;
  args_info->rodlength_help = gengetopt_args_info_help[72] ;
  args_info->tet_param_help = gengetopt_args_info_help[73] ;
  args_info->tet_param_z_help = gengetopt_args_info_help[74] ;
  args_info->tet_param_r_help = gengetopt_args_info_help[75] ;
  args_info->tet_param_dens_help = gengetopt_args_info_help[76] ;
  args_info->tet_param_xyz_help = gengetopt_args_info_help[77] ;
  args_info->rnemdz_help = gengetopt_args_info_help[78] ;
  args_info->rnemdr_help = gengetopt_args_info_help[79] ;
  args_info->rnemdrt_help = gengetopt_args_info_help[80] ;
  args_info->nitrile_help = gengetopt_args_info_help[81] ;
  args_info->multipole_help = gengetopt_args_info_help[82] ;
  args_info->surfDiffusion_help = gengetopt_args_info_help[83] ;
  args_info->cn_help = gengetopt_args_info_help[84] ;
  args_info->scn_help = gengetopt_args_info_help[85] ;
  args_info->gcn_help = gengetopt_args_info_help[86] ;
  args_info->hbond_help = gengetopt_args_info_help[87] ;
  args_info->hbondz_help = gengetopt_args_info_help[88] ;
  args_info->hbondzvol_help = gengetopt_args_info_help[89] ;
  args_info->hbondr_help = gengetopt_args_info_help[90] ;
  args_info->hbondrvol_help = gengetopt_args_info_help[91] ;
  args_info->potDiff_help = gengetopt_args_info_help[92] ;
  args_info->tet_hb_help = gengetopt_args_info_help[93] ;
  args_info->kirkwood_help = gengetopt_args_info_help[94] ;
  args_info->kirkwoodQ_help = gengetopt_args_info_help[95] ;
  args_info->densityfield_help = gengetopt_args_info_help[96] ;
  args_info->velocityfield_help = gengetopt_args_info_help[97] ;
  args_info->velocityZ_help = gengetopt_args_info_help[98] ;
  args_info->eam_density_help = gengetopt_args_info_help[99] ;
  args_info->net_charge_help = gengetopt_args_info_help[100] ;
  args_info->current_density_help = gengetopt_args_info_help[101] ;
  args_info->chargez_help = gengetopt_args_info_help[102] ;
  args_info->charger_help = gengetopt_args_info_help[103] ;
  args_info->massdensityz_help = gengetopt_args_info_help[104] ;
  args_info->massdensityr_help = gengetopt_args_info_help[105] ;
  args_info->numberz_help = gengetopt_args_info_help[106] ;
  args_info->numberr_help = gengetopt_args_info_help[107] ;
  args_info->charge_density_z_help = gengetopt_args_info_help[108] ;
  args_info->countz_help = gengetopt_args_info_help[109] ;
  args_info->momentum_distribution_help = gengetopt_args_info_help[110] ;
  args_info->dipole_orientation_help = gengetopt_args_info_help[111] ;
  args_info->order_prob_help = gengetopt_args_info_help[112] ;
...
cmdline_parser_release (struct gengetopt_args_info *args_info)
{
  ...
  free_string_field (&(args_info->binWidth_orig));
...
cmdline_parser_dump(FILE *outfile, struct gengetopt_args_info *args_info)
{
  ...
  if (args_info->binWidth_given)
    write_into_file(outfile, "binWidth", args_info->binWidth_orig, 0);
  ...
  if (args_info->mcount_given)
    write_into_file(outfile, "mcount", 0, 0 );
  ...
  if (args_info->kirkwood_buff_given)
  ...
  if (args_info->tet_param_r_given)
    write_into_file(outfile, "tet_param_r", 0, 0 );
  ...
  if (args_info->hbondz_given)
    write_into_file(outfile, "hbondz", 0, 0 );
  if (args_info->hbondzvol_given)
  ...
  if (args_info->massdensityz_given)
    write_into_file(outfile, "massdensityz", 0, 0 );
  if (args_info->massdensityr_given)
    write_into_file(outfile, "massdensityr", 0, 0 );
  ...
  while (1)
    {
      ...
      switch (c)
        ...
        case 0:	/* Long option with no short option */
          ...
          /* width of radial bins in angstroms.  */
          else if (strcmp (long_options[option_index].name, "binWidth") == 0)
          {
          
          
            if (update_arg( (void *)&(args_info->binWidth_arg), 
                 &(args_info->binWidth_orig), &(args_info->binWidth_given),
                &(local_args_info.binWidth_given), optarg, 0, "1.0", ARG_DOUBLE,
                check_ambiguity, override, 0, 0,
                "binWidth", '-',
                additional_error))
              goto failure;
          ...
          /* count of objects matching selection criteria (and associated statistics).  */
          ...
          else if (strcmp (long_options[option_index].name, "mcount") == 0)
          {
            ...
            if (update_arg( 0 , 
                 0 , &(args_info->mcount_given),
                &(local_args_info.mcount_given), optarg, 0, 0, ARG_NO,
                check_ambiguity, override, 0, 0,
                "mcount", '-',
                additional_error))
              goto failure;
          ...
          /* Kirkwood-Buff integrals (--sele1 and --sele2 must both be specified).  */
          else if (strcmp (long_options[option_index].name, "kirkwood_buff") == 0)
          {
            ...
            if (update_arg( 0 , 
                 0 , &(args_info->kirkwood_buff_given),
          ...
          /* spatially-resolved tetrahedrality order parameter Qk(r) around a third selection.  */
          else if (strcmp (long_options[option_index].name, "tet_param_r") == 0)
          {
            ...
            if (update_arg( 0 , 
                 0 , &(args_info->tet_param_r_given),
                &(local_args_info.tet_param_r_given), optarg, 0, 0, ARG_NO,
                check_ambiguity, override, 0, 0,
                "tet_param_r", '-',
                additional_error))
              goto failure;
          ...
          /* Hydrogen Bonding density binned by z (rcut and thetacut must be specified).  */
          else if (strcmp (long_options[option_index].name, "hbondz") == 0)
          {
            ...
            if (update_arg( 0 , 
                 0 , &(args_info->hbondz_given),
                &(local_args_info.hbondz_given), optarg, 0, 0, ARG_NO,
                check_ambiguity, override, 0, 0,
                "hbondz", '-',
                additional_error))
              goto failure;
          ...
          /* Hydrogen Bonding density binned by z and normalized by bin volume (rcut and thetacut must be specified).  */
          else if (strcmp (long_options[option_index].name, "hbondzvol") == 0)
          {
            ...
            if (update_arg( 0 , 
                 0 , &(args_info->hbondzvol_given),
                &(local_args_info.hbondzvol_given), optarg, 0, 0, ARG_NO,
                check_ambiguity, override, 0, 0,
                "hbondzvol", '-',
                additional_error))
              goto failure;
          ...
          /* Hydrogen Bonding density binned by r (rcut and thetacut must be specified).  */
          else if (strcmp (long_options[option_index].name, "hbondr") == 0)
          {
          ...
          /* computes the mass density of the selection along selected axis.  */
          else if (strcmp (long_options[option_index].name, "massdensityz") == 0)
          {
            ...
            if (update_arg( 0 , 
                 0 , &(args_info->massdensityz_given),
                &(local_args_info.massdensityz_given), optarg, 0, 0, ARG_NO,
                check_ambiguity, override, 0, 0,
                "massdensityz", '-',
                additional_error))
              goto failure;
          ...
          /* computes the mass density of the selection as a function of the radius from the center of mass.  */
          else if (strcmp (long_options[option_index].name, "massdensityr") == 0)
          {
            ...
            if (update_arg( 0 , 
                 0 , &(args_info->massdensityr_given),
                &(local_args_info.massdensityr_given), optarg, 0, 0, ARG_NO,
                check_ambiguity, override, 0, 0,
                "massdensityr", '-',
                additional_error))
              goto failure;
