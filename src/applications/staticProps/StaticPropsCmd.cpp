/*
  ...
  /opt/local/bin/gengetopt -C --input=StaticProps.ggo --no-handle-error --show-required --unamed-opts --header-extension=hpp --file-name=StaticPropsCmd --c-extension=cpp --include-getopt --no-handle-error --include-getopt --show-required --unamed-opts --file-name=StaticPropsCmd --c-extension=cpp --header-extension=hpp
