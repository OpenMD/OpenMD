...
void init_args_info(struct gengetopt_args_info *args_info)
{
  ...
  args_info->charge_density_z_help = gengetopt_args_info_help[91] ;
  args_info->countz_help = gengetopt_args_info_help[92] ;
  args_info->momentum_distribution_help = gengetopt_args_info_help[93] ;
  args_info->dipole_orientation_help = gengetopt_args_info_help[94] ;
