    ...
    switch (c) {
      ...
      case 'x': /* make the system repeat in the x direction.  */
        ...
        if (update_arg((void *)&(args_info->repeatX_arg),
                       ...
                       &(local_args_info.repeatX_given), optarg, 0, "1",
                       ARG_INT, check_ambiguity, override, 0, 0, "repeatX", 'x',
                       additional_error))
          goto failure;
      ...
      case 'y': /* make the system repeat in the y direction.  */
        ...
        if (update_arg((void *)&(args_info->repeatY_arg),
                       ...
                       &(local_args_info.repeatY_given), optarg, 0, "1",
                       ARG_INT, check_ambiguity, override, 0, 0, "repeatY", 'y',
                       additional_error))
          goto failure;
      ...
      case 'z': /* make the system repeat in the z direction.  */
        ...
        if (update_arg((void *)&(args_info->repeatZ_arg),
                       ...
                       &(local_args_info.repeatZ_given), optarg, 0, "1",
                       ARG_INT, check_ambiguity, override, 0, 0, "repeatZ", 'z',
                       additional_error))
          goto failure;
      ...
      case 'p': /* rotate all coordinates Euler angle Phi.  */
        ...
        if (update_arg((void *)&(args_info->rotatePhi_arg),
                       &(args_info->rotatePhi_orig),
                       &(args_info->rotatePhi_given),
                       &(local_args_info.rotatePhi_given), optarg, 0, "0.0",
                       ARG_DOUBLE, check_ambiguity, override, 0, 0, "rotatePhi",
                       'p', additional_error))
          goto failure;
      ...
      case 'q': /* rotate all coordinates Euler angle Theta.  */
        ...
        if (update_arg((void *)&(args_info->rotateTheta_arg),
                       ...
                       ARG_DOUBLE, check_ambiguity, override, 0, 0,
                       "rotateTheta", 'q', additional_error))
          goto failure;
      ...
      case 'r': /* rotate all coordinates Euler angle Psi.  */
        ...
        if (update_arg((void *)&(args_info->rotatePsi_arg),
                       &(args_info->rotatePsi_orig),
                       &(args_info->rotatePsi_given),
                       &(local_args_info.rotatePsi_given), optarg, 0, "0.0",
                       ARG_DOUBLE, check_ambiguity, override, 0, 0, "rotatePsi",
                       'r', additional_error))
          goto failure;
