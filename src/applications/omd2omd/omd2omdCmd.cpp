/*
  ...
  gengetopt --no-handle-error --include-getopt --show-required --unamed-opts --file-name=omd2omdCmd --c-extension=cpp --header-extension=hpp
  ...
  while (1)
    {
      ...
      c = custom_getopt_long (argc, argv, "hVi:o:x:y:z:t:u:v:p:q:r:m:", long_options, &option_index);
      ...
      switch (c)
        ...
        case 't':	/* translate all x coordinates by some amount.  */
          ...
          if (update_arg( (void *)&(args_info->translateX_arg), 
               &(args_info->translateX_orig), &(args_info->translateX_given),
              &(local_args_info.translateX_given), optarg, 0, "0.0", ARG_DOUBLE,
              check_ambiguity, override, 0, 0,
              "translateX", 't',
              additional_error))
            goto failure;
        ...
        case 'u':	/* translate all y coordinates by some amount.  */
          ...
          if (update_arg( (void *)&(args_info->translateY_arg), 
               &(args_info->translateY_orig), &(args_info->translateY_given),
              &(local_args_info.translateY_given), optarg, 0, "0.0", ARG_DOUBLE,
              check_ambiguity, override, 0, 0,
              "translateY", 'u',
              additional_error))
            goto failure;
        ...
        case 'v':	/* translate all z coordinates by some amount.  */
          ...
          if (update_arg( (void *)&(args_info->translateZ_arg), 
               &(args_info->translateZ_orig), &(args_info->translateZ_given),
        ...
        case 'm':	/* rewrap molecules around the molecular center of mass.  */
          ...
          if (update_arg( (void *)&(args_info->repairMolecules_arg), 
               &(args_info->repairMolecules_orig), &(args_info->repairMolecules_given),
              &(local_args_info.repairMolecules_given), optarg, 0, "1", ARG_INT,
              check_ambiguity, override, 0, 0,
              "repairMolecules", 'm',
              additional_error))
            goto failure;
