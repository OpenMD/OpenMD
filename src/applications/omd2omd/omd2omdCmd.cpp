/*
  ...
  /opt/local/bin/gengetopt -C --input=omd2omd.ggo --no-handle-version --no-handle-help --no-handle-error --include-getopt --show-required --unamed-opts --file-name=omd2omdCmd --c-extension=cpp --header-extension=hpp
