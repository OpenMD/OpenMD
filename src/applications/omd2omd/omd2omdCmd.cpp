/*
  ...
  --file-name=omd2omdCmd --c-extension=cpp --header-extension=hpp
...
const char* gengetopt_args_info_purpose =
    "Takes a MetaData file and maps all StuntDoubles back to the periodic "
    "box.\nWill "
    "optionally replicate the system in the three box directions, or "
    "\ntranslate every "
    "object in the box and before writing out a new MetaData "
    "file.\n\nExample:\n  "
    "omd2omd -i lipidSystem.omd -o bigLipidSystem.omd -x 2 -y 2 -z 1 -v 35.0";

const char* gengetopt_args_info_usage = "Usage: omd2omd [OPTION]... [FILE]...";
...
const char* gengetopt_args_info_help[] = {
    ...
    "  -i, --input=filename       use specified input (.omd, .dump, .eor) "
    "file\n         "
    "                      (mandatory)",
    ...
    "          "
    "                    (default=`0.0')",
    "  -p, --rotatePhi=DOUBLE     rotate all coordinates Euler angle Phi\n     "
    "          "
    "                (default=`0.0')",
    ...
    "          "
    "                (default=`0.0')",
    "  -m, --repairMolecules=INT  rewrap molecules around the molecular center "
    "of\n      "
    "                         mass  (default=`1')",
    0};
...
static void clear_args(struct gengetopt_args_info* args_info) {
  ...
  args_info->repeatZ_arg          = 1;
  args_info->repeatZ_orig         = NULL;
  args_info->translateX_arg       = 0.0;
  args_info->translateX_orig      = NULL;
  args_info->translateY_arg       = 0.0;
...
static void cmdline_parser_release(struct gengetopt_args_info* args_info) {
  ...
  free_string_field(&(args_info->repairMolecules_orig));
...
int cmdline_parser_dump(FILE* outfile, struct gengetopt_args_info* args_info) {
  ...
  if (args_info->translateX_given)
    write_into_file(outfile, "translateX", args_info->translateX_orig, 0);
  if (args_info->translateY_given)
  ...
  if (args_info->repairMolecules_given)
    write_into_file(outfile, "repairMolecules", args_info->repairMolecules_orig,
                    0);
...
int cmdline_parser_internal(int argc, char** argv,
  ...
  while (1) {
    ...
    c = custom_getopt_long(
        argc, argv, "hVi:o:x:y:z:t:u:v:p:q:r:m:", long_options, &option_index);
    ...
    case 'o': /* use specified output file.  */
      ...
      break;
    case 'x': /* make the system repeat in the x direction.  */

      if (update_arg((void*)&(args_info->repeatX_arg),
                     &(args_info->repeatX_orig), &(args_info->repeatX_given),
                     &(local_args_info.repeatX_given), optarg, 0, "1", ARG_INT,
                     check_ambiguity, override, 0, 0, "repeatX", 'x',
                     additional_error))
        goto failure;

      break;
    case 'y': /* make the system repeat in the y direction.  */

      if (update_arg((void*)&(args_info->repeatY_arg),
                     &(args_info->repeatY_orig), &(args_info->repeatY_given),
                     &(local_args_info.repeatY_given), optarg, 0, "1", ARG_INT,
                     check_ambiguity, override, 0, 0, "repeatY", 'y',
                     additional_error))
        goto failure;

      break;
    case 'z': /* make the system repeat in the z direction.  */

      if (update_arg((void*)&(args_info->repeatZ_arg),
                     &(args_info->repeatZ_orig), &(args_info->repeatZ_given),
                     &(local_args_info.repeatZ_given), optarg, 0, "1", ARG_INT,
                     check_ambiguity, override, 0, 0, "repeatZ", 'z',
                     additional_error))
        goto failure;

      break;
    case 't': /* translate all x coordinates by some amount.  */

      if (update_arg((void*)&(args_info->translateX_arg),
                     &(args_info->translateX_orig),
                     &(args_info->translateX_given),
                     &(local_args_info.translateX_given), optarg, 0, "0.0",
                     ARG_DOUBLE, check_ambiguity, override, 0, 0, "translateX",
                     't', additional_error))
        goto failure;

      break;
    case 'u': /* translate all y coordinates by some amount.  */

      if (update_arg((void*)&(args_info->translateY_arg),
                     &(args_info->translateY_orig),
                     &(args_info->translateY_given),
                     &(local_args_info.translateY_given), optarg, 0, "0.0",
                     ARG_DOUBLE, check_ambiguity, override, 0, 0, "translateY",
                     'u', additional_error))
        goto failure;

      break;
    case 'v': /* translate all z coordinates by some amount.  */

      if (update_arg((void*)&(args_info->translateZ_arg),
                     &(args_info->translateZ_orig),
                     &(args_info->translateZ_given),
                     &(local_args_info.translateZ_given), optarg, 0, "0.0",
                     ARG_DOUBLE, check_ambiguity, override, 0, 0, "translateZ",
                     'v', additional_error))
        goto failure;

      break;
    case 'p': /* rotate all coordinates Euler angle Phi.  */

      if (update_arg(
              (void*)&(args_info->rotatePhi_arg), &(args_info->rotatePhi_orig),
              &(args_info->rotatePhi_given), &(local_args_info.rotatePhi_given),
              optarg, 0, "0.0", ARG_DOUBLE, check_ambiguity, override, 0, 0,
              "rotatePhi", 'p', additional_error))
        goto failure;

      break;
    case 'q': /* rotate all coordinates Euler angle Theta.  */

      if (update_arg((void*)&(args_info->rotateTheta_arg),
                     &(args_info->rotateTheta_orig),
                     &(args_info->rotateTheta_given),
                     &(local_args_info.rotateTheta_given), optarg, 0, "0.0",
                     ARG_DOUBLE, check_ambiguity, override, 0, 0, "rotateTheta",
                     'q', additional_error))
        goto failure;

      break;
    case 'r': /* rotate all coordinates Euler angle Psi.  */

      if (update_arg(
              (void*)&(args_info->rotatePsi_arg), &(args_info->rotatePsi_orig),
              &(args_info->rotatePsi_given), &(local_args_info.rotatePsi_given),
              optarg, 0, "0.0", ARG_DOUBLE, check_ambiguity, override, 0, 0,
              "rotatePsi", 'r', additional_error))
        goto failure;

      break;
    case 'm': /* rewrap molecules around the molecular center of mass.  */

      if (update_arg((void*)&(args_info->repairMolecules_arg),
                     &(args_info->repairMolecules_orig),
                     &(args_info->repairMolecules_given),
                     &(local_args_info.repairMolecules_given), optarg, 0, "1",
                     ARG_INT, check_ambiguity, override, 0, 0,
                     "repairMolecules", 'm', additional_error))
        goto failure;
