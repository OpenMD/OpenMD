/*
  ...
  --file-name=simpleBuilderCmd --c-extension=cpp --header-extension=hpp
...
const char *gengetopt_args_info_purpose =
    ...
    "OpenMD "
    "file to specify the components that are to be placed\non the lattice. The "
    "total "
    "number of placed molecules will be shown at\nthe top of the configuration "
    "file that "
    "is generated, and that number\nmay not match the original meta-data file, "
    "so a new "
...
static void init_args_info(struct gengetopt_args_info *args_info) {
  ...
  args_info->lattice_help = gengetopt_args_info_help[7];
}
