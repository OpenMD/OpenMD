/*
  ...
  gengetopt --no-handle-error --include-getopt --show-required --unamed-opts --file-name=simpleBuilderCmd --c-extension=cpp --header-extension=hpp
...
const char *gengetopt_args_info_help[] = {
  ...
  "  -l, --lattice=STRING  Lattice Type  (possible values=\"FCC\", \"BCC\",\n                          \"SC\")",
    0
};
