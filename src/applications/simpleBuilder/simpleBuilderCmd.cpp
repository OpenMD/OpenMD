/*
  ...
  /opt/local/bin/gengetopt -C --input=simpleBuilder.ggo --no-handle-error --include-getopt --show-required --unamed-opts --file-name=simpleBuilderCmd --c-extension=cpp --header-extension=hpp
