/*
  ...
  /opt/local/bin/gengetopt -C --input=recenter.ggo --no-handle-error --include-getopt --show-required --unamed-opts --file-name=recenterCmd --c-extension=cpp --header-extension=hpp
