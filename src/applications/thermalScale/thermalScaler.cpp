...
/**
 * @file thermalScaler.cpp
 * @author Patrick Louden
 * @date 10/26/2017
 * @version 1.0
 */
...
#include "thermalScalerCmd.hpp"
#include "ThermalScale.hpp"
...
int main(int argc, char *argv []) {
  ...
  ThermalScale* thermalScale = new ThermalScale(info);
  ...
  for (int istep = 0; istep < nFrames; istep++) {
    ...
    thermalScale->scaleTemp(temperature);
    writer->writeDump();
  }
