/*
  ...
  /opt/local/bin/gengetopt -C --input=thermalScaler.ggo --no-handle-error --include-getopt --show-required --unamed-opts --file-name=thermalScalerCmd --c-extension=cpp --header-extension=hpp --no-handle-error --include-getopt --show-required --unamed-opts --file-name=thermalScalerCmd --c-extension=cpp --header-extension=hpp
...
const char *gengetopt_args_info_purpose = "Sets the temperature of a (.omd) file by scaling the kinetic energy of all\nmolecules within the file.";

const char *gengetopt_args_info_usage = "Usage: thermalScaler [OPTIONS]... [FILES]...";
...
const char *gengetopt_args_info_help[] = {
  ...
  "  -t, --temperature=DOUBLE  temperature (K) (mandatory)",
    0
};
  ...
  while (1)
    {
      ...
      c = custom_getopt_long (argc, argv, "hVo:t:", long_options, &option_index);
