...
struct gengetopt_args_info {
  ...
  char* frame_orig; /**< @brief print every n frame original value given at
                       command line.  */
  ...
  const char* periodicBox_help; /**< @brief map to the periodic box help
                                   description.  */
  int zconstraint_flag; /**< @brief replace the atom types of zconstraint
                           molecules (default=off).  */
  const char* zconstraint_help; /**< @brief replace the atom types of
                                   zconstraint molecules help description.  */
  int rigidbody_flag;           /**< @brief add a pseudo COM atom to rigidbody
                                   (default=off).  */
  const char* rigidbody_help;   /**< @brief add a pseudo COM atom to rigidbody
                                   help description.  */
  int watertype_flag;           /**< @brief replace the atom type of water model
                                   (default=on).  */
  const char* watertype_help;   /**< @brief replace the atom type of water model
                                   help description.  */
  char* selection_arg;          /**< @brief general selection syntax.  */
  char* selection_orig; /**< @brief general selection syntax original value
                           given at command line.  */
  const char*
      selection_help; /**< @brief general selection syntax help description.  */
  char* originsele_arg;        /**< @brief select origin.  */
  char* originsele_orig;       /**< @brief select origin original value given at
                                  command line.  */
  const char* originsele_help; /**< @brief select origin help description.  */
  char* refsele_arg;           /**< @brief select reference.  */
  char* refsele_orig;       /**< @brief select reference original value given at
                               command line.  */
  const char* refsele_help; /**< @brief select reference help description.  */
  int repeatX_arg; /**< @brief The number of images to repeat in the x direction
                      (default='0').  */
  char* repeatX_orig;       /**< @brief The number of images to repeat in the x
                               direction original value given at command line.  */
  const char* repeatX_help; /**< @brief The number of images to repeat in the x
                               direction help description.  */
  int repeatY_arg; /**< @brief The number of images to repeat in the y direction
                      (default='0').  */
  char* repeatY_orig;       /**< @brief The number of images to repeat in the y
                               direction original value given at command line.  */
  const char* repeatY_help; /**< @brief The number of images to repeat in the y
                               direction help description.  */
  int repeatZ_arg; /**< @brief The number of images to repeat in the z direction
                      (default='0').  */
  char* repeatZ_orig;       /**< @brief The number of images to repeat in the z
                               direction original value given at command line.  */
  const char* repeatZ_help; /**< @brief The number of images to repeat in the z
                               direction help description.  */
  int basetype_flag; /**< @brief Convert to base atom type (default=off).  */
  const char*
      basetype_help; /**< @brief Convert to base atom type help description.  */
  int velocities_flag; /**< @brief Print velocities in xyz file (default=off).
                        */
  const char* velocities_help; /**< @brief Print velocities in xyz file help
                                  description.  */
  int forces_flag; /**< @brief Print forces xyz file (default=off).  */
  const char*
      forces_help;  /**< @brief Print forces xyz file help description.  */
  int vectors_flag; /**< @brief Print vectors (dipoles, etc) in xyz file
                       (default=off).  */
  const char* vectors_help; /**< @brief Print vectors (dipoles, etc) in xyz file
                               help description.  */
  int charges_flag; /**< @brief Print charges in xyz file (default=off).  */
  const char*
      charges_help; /**< @brief Print charges in xyz file help description.  */
  int efield_flag;  /**< @brief Print electric field vector in xyz file
                       (default=off).  */
  const char* efield_help; /**< @brief Print electric field vector in xyz file
                              help description.  */
  int globalID_flag; /**< @brief Print global ID in xyz file (default=off).  */
  const char* globalID_help; /**< @brief Print global ID in xyz file help
                                description.  */
