/*
  ...
  --file-name=Dump2XYZCmd --c-extension=cpp --header-extension=hpp
...
const char *gengetopt_args_info_purpose =
    "Converts an OpenMD dump file into a file suitable for viewing in "
    "a\nmolecular "
    "dynamics viewer like Jmol or VMD";
...
const char *gengetopt_args_info_help[] = {
    ...
    "  -z, --zconstraint             replace the atom types of zconstraint "
    "molecules\n   "
    "                               (default=off)",
    ...
    "  -v, --velocities              Print velocities in xyz file  "
    "(default=off)",
    "  -f, --forces                  Print forces xyz file  (default=off)",
    "  -u, --vectors                 Print vectors (dipoles, etc) in xyz "
    "file\n          "
    "                        (default=off)",
    ...
    "          "
    "                       (default=off)",
    "  -g, --globalID                Print global ID in xyz file  "
    "(default=off)",
    0};

typedef enum { ARG_NO, ARG_FLAG, ARG_STRING, ARG_INT } cmdline_parser_arg_type;
...
static void init_args_info(struct gengetopt_args_info *args_info) {
  ...
  args_info->globalID_help = gengetopt_args_info_help[22];
}
...
int cmdline_parser_dump(FILE *outfile, struct gengetopt_args_info *args_info) {
  ...
  if (args_info->water_given) write_into_file(outfile, "water", 0, 0);
  ...
  if (args_info->rigidbody_given) write_into_file(outfile, "rigidbody", 0, 0);
  if (args_info->watertype_given) write_into_file(outfile, "watertype", 0, 0);
  ...
  if (args_info->basetype_given) write_into_file(outfile, "basetype", 0, 0);
  if (args_info->velocities_given) write_into_file(outfile, "velocities", 0, 0);
  if (args_info->forces_given) write_into_file(outfile, "forces", 0, 0);
  if (args_info->vectors_given) write_into_file(outfile, "vectors", 0, 0);
  if (args_info->charges_given) write_into_file(outfile, "charges", 0, 0);
  if (args_info->efield_given) write_into_file(outfile, "efield", 0, 0);
  if (args_info->globalID_given) write_into_file(outfile, "globalID", 0, 0);
...
int cmdline_parser_internal(int argc, char **argv,
  ...
  while (1) {
    ...
    static struct option long_options[] = {
        ...
        {"frame", 1, NULL, 'n'},       {"water", 0, NULL, 'w'},
        {"periodicBox", 0, NULL, 'm'}, {"zconstraint", 0, NULL, 'z'},
        {"rigidbody", 0, NULL, 'r'},   {"watertype", 0, NULL, 't'},
        {"selection", 1, NULL, 's'},   {"originsele", 1, NULL, 0},
        {"refsele", 1, NULL, 0},       {"repeatX", 1, NULL, 0},
        {"repeatY", 1, NULL, 0},       {"repeatZ", 1, NULL, 0},
        {"basetype", 0, NULL, 'b'},    {"velocities", 0, NULL, 'v'},
        {"forces", 0, NULL, 'f'},      {"vectors", 0, NULL, 'u'},
        {"charges", 0, NULL, 'c'},     {"efield", 0, NULL, 'e'},
        {"globalID", 0, NULL, 'g'},    {0, 0, 0, 0}};
    ...
    c = custom_getopt_long(argc, argv, "hVi:o:n:wmzrts:bvfuceg", long_options,
                           &option_index);
    ...
    switch (c) {
      ...
      case 'n': /* print every n frame.  */
        ...
        if (update_arg((void *)&(args_info->frame_arg),
                       ...
                       check_ambiguity, override, 0, 0, "frame", 'n',
                       additional_error))
          goto failure;
      ...
      case 'w': /* skip the the waters.  */
        ...
        if (update_arg((void *)&(args_info->water_flag), 0,
      ...
      case 'm': /* map to the periodic box.  */
        ...
        if (update_arg((void *)&(args_info->periodicBox_flag), 0,
                       &(args_info->periodicBox_given),
                       &(local_args_info.periodicBox_given), optarg, 0, 0,
                       ARG_FLAG, check_ambiguity, override, 1, 0, "periodicBox",
                       'm', additional_error))
          goto failure;
      ...
      case 'z': /* replace the atom types of zconstraint molecules.  */
        ...
        if (update_arg((void *)&(args_info->zconstraint_flag), 0,
                       &(args_info->zconstraint_given),
                       &(local_args_info.zconstraint_given), optarg, 0, 0,
                       ARG_FLAG, check_ambiguity, override, 1, 0, "zconstraint",
                       'z', additional_error))
          goto failure;
      ...
      case 'r': /* add a pseudo COM atom to rigidbody.  */
        ...
        if (update_arg((void *)&(args_info->rigidbody_flag), 0,
                       &(args_info->rigidbody_given),
                       &(local_args_info.rigidbody_given), optarg, 0, 0,
                       ARG_FLAG, check_ambiguity, override, 1, 0, "rigidbody",
                       'r', additional_error))
          goto failure;
      ...
      case 't': /* replace the atom type of water model.  */
        ...
        if (update_arg((void *)&(args_info->watertype_flag), 0,
                       &(args_info->watertype_given),
                       &(local_args_info.watertype_given), optarg, 0, 0,
                       ARG_FLAG, check_ambiguity, override, 1, 0, "watertype",
                       't', additional_error))
          goto failure;
      ...
      case 's': /* general selection syntax.  */
        ...
        if (update_arg((void *)&(args_info->selection_arg),
                       &(args_info->selection_orig),
                       &(args_info->selection_given),
                       &(local_args_info.selection_given), optarg, 0, 0,
                       ARG_STRING, check_ambiguity, override, 0, 0, "selection",
                       's', additional_error))
          goto failure;
      ...
      case 'b': /* Convert to base atom type.  */
        ...
        if (update_arg((void *)&(args_info->basetype_flag), 0,
                       &(args_info->basetype_given),
                       &(local_args_info.basetype_given), optarg, 0, 0,
                       ARG_FLAG, check_ambiguity, override, 1, 0, "basetype",
                       'b', additional_error))
          goto failure;
      ...
      case 'v': /* Print velocities in xyz file.  */
        ...
        if (update_arg((void *)&(args_info->velocities_flag), 0,
                       &(args_info->velocities_given),
                       &(local_args_info.velocities_given), optarg, 0, 0,
                       ARG_FLAG, check_ambiguity, override, 1, 0, "velocities",
                       'v', additional_error))
          goto failure;
      ...
      case 'f': /* Print forces xyz file.  */
        ...
        if (update_arg((void *)&(args_info->forces_flag), 0,
                       &(args_info->forces_given),
      ...
      case 'u': /* Print vectors (dipoles, etc) in xyz file.  */
        ...
        if (update_arg((void *)&(args_info->vectors_flag), 0,
                       &(args_info->vectors_given),
      ...
      case 'c': /* Print charges in xyz file.  */
        ...
        if (update_arg((void *)&(args_info->charges_flag), 0,
                       &(args_info->charges_given),
      ...
      case 'e': /* Print electric field vector in xyz file.  */
        ...
        if (update_arg((void *)&(args_info->efield_flag), 0,
                       &(args_info->efield_given),
        ...
        break;
      case 'g': /* Print global ID in xyz file.  */

        if (update_arg((void *)&(args_info->globalID_flag), 0,
                       &(args_info->globalID_given),
                       &(local_args_info.globalID_given), optarg, 0, 0,
                       ARG_FLAG, check_ambiguity, override, 1, 0, "globalID",
                       'g', additional_error))
          goto failure;
      ...
      case 0: /* Long option with no short option */
        ...
        if (strcmp(long_options[option_index].name, "originsele") == 0) {
          if (update_arg((void *)&(args_info->originsele_arg),
                         &(args_info->originsele_orig),
                         &(args_info->originsele_given),
                         &(local_args_info.originsele_given), optarg, 0, 0,
                         ARG_STRING, check_ambiguity, override, 0, 0,
                         "originsele", '-', additional_error))
            goto failure;
        ...
        /* The number of images to repeat in the x direction.  */
          ...
          if (update_arg(
                  (void *)&(args_info->repeatX_arg), &(args_info->repeatX_orig),
                  &(args_info->repeatX_given), &(local_args_info.repeatX_given),
                  optarg, 0, "0", ARG_INT, check_ambiguity, override, 0, 0,
                  "repeatX", '-', additional_error))
            goto failure;
        ...
        /* The number of images to repeat in the y direction.  */
          ...
          if (update_arg(
                  (void *)&(args_info->repeatY_arg), &(args_info->repeatY_orig),
                  &(args_info->repeatY_given), &(local_args_info.repeatY_given),
                  optarg, 0, "0", ARG_INT, check_ambiguity, override, 0, 0,
                  "repeatY", '-', additional_error))
            goto failure;
        ...
        /* The number of images to repeat in the z direction.  */
          ...
          if (update_arg(
                  (void *)&(args_info->repeatZ_arg), &(args_info->repeatZ_orig),
                  &(args_info->repeatZ_given), &(local_args_info.repeatZ_given),
                  optarg, 0, "0", ARG_INT, check_ambiguity, override, 0, 0,
                  "repeatZ", '-', additional_error))
            goto failure;
        }
