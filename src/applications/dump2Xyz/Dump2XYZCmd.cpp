/*
  ...
  gengetopt --no-handle-error --include-getopt --show-required --unamed-opts --file-name=Dump2XYZCmd --c-extension=cpp --header-extension=hpp
...
const char *gengetopt_args_info_purpose = "Converts an OpenMD dump file into a file suitable for viewing in a\nmolecular dynamics viewer like Jmol or VMD";
...
const char *gengetopt_args_info_help[] = {
  ...
  "  -g, --globalID                Print global ID in xyz file  (default=off)",
    0
};
  ...
  while (1)
    {
      ...
      c = custom_getopt_long (argc, argv, "hVi:o:n:wmzrts:bvfuceg", long_options, &option_index);
      ...
      switch (c)
        ...
        case 'g':	/* Print global ID in xyz file.  */
          ...
          if (update_arg((void *)&(args_info->globalID_flag), 0, &(args_info->globalID_given),
