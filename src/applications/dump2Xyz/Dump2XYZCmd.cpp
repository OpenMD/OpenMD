/*
  ...
  /opt/local/bin/gengetopt -C --input=Dump2XYZ.ggo --no-handle-error --include-getopt --show-required --unamed-opts --file-name=Dump2XYZCmd --c-extension=cpp --header-extension=hpp
  ...
  while (1)
    {
      ...
      c = custom_getopt_long (argc, argv, "hVi:o:n:wmzrts:bvfuce", long_options, &option_index);
