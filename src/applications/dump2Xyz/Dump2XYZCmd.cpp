...
int cmdline_parser_internal(int argc, char** argv,
  ...
  while (1) {
    ...
    case 'n': /* print every n frame.  */
      ...
      if (update_arg((void*)&(args_info->frame_arg), &(args_info->frame_orig),
                     &(args_info->frame_given), &(local_args_info.frame_given),
                     optarg, 0, "1", ARG_INT, check_ambiguity, override, 0, 0,
                     "frame", 'n', additional_error))
        goto failure;
    ...
    case 'w': /* skip the the waters.  */
      ...
      if (update_arg((void*)&(args_info->water_flag), 0,
                     &(args_info->water_given), &(local_args_info.water_given),
                     optarg, 0, 0, ARG_FLAG, check_ambiguity, override, 1, 0,
                     "water", 'w', additional_error))
        goto failure;
    ...
    case 's': /* general selection syntax.  */
      ...
      if (update_arg(
              (void*)&(args_info->selection_arg), &(args_info->selection_orig),
              &(args_info->selection_given), &(local_args_info.selection_given),
              optarg, 0, 0, ARG_STRING, check_ambiguity, override, 0, 0,
              "selection", 's', additional_error))
        goto failure;
    ...
    case 'f': /* Print forces xyz file.  */
      ...
      if (update_arg(
              (void*)&(args_info->forces_flag), 0, &(args_info->forces_given),
              &(local_args_info.forces_given), optarg, 0, 0, ARG_FLAG,
              check_ambiguity, override, 1, 0, "forces", 'f', additional_error))
        goto failure;
    ...
    case 'e': /* Print electric field vector in xyz file.  */
      ...
      if (update_arg(
              (void*)&(args_info->efield_flag), 0, &(args_info->efield_given),
              &(local_args_info.efield_given), optarg, 0, 0, ARG_FLAG,
              check_ambiguity, override, 1, 0, "efield", 'e', additional_error))
        goto failure;
    ...
    case 'g': /* Print global ID in xyz file.  */
      ...
      if (update_arg((void*)&(args_info->globalID_flag), 0,
                     ...
                     &(local_args_info.globalID_given), optarg, 0, 0, ARG_FLAG,
                     check_ambiguity, override, 1, 0, "globalID", 'g',
                     additional_error))
        goto failure;
    ...
    case 0: /* Long option with no short option */
      ...
      /* The number of images to repeat in the x direction.  */
        ...
        if (update_arg((void*)&(args_info->repeatX_arg),
                       ...
                       &(local_args_info.repeatX_given), optarg, 0, "0",
                       ARG_INT, check_ambiguity, override, 0, 0, "repeatX", '-',
                       additional_error))
          goto failure;
      ...
      /* The number of images to repeat in the y direction.  */
        ...
        if (update_arg((void*)&(args_info->repeatY_arg),
                       ...
                       &(local_args_info.repeatY_given), optarg, 0, "0",
                       ARG_INT, check_ambiguity, override, 0, 0, "repeatY", '-',
                       additional_error))
          goto failure;
      ...
      /* The number of images to repeat in the z direction.  */
        ...
        if (update_arg((void*)&(args_info->repeatZ_arg),
                       ...
                       &(local_args_info.repeatZ_given), optarg, 0, "0",
                       ARG_INT, check_ambiguity, override, 0, 0, "repeatZ", '-',
                       additional_error))
          goto failure;
      }
