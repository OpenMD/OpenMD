...
struct gengetopt_args_info {
  ...
  char* centroidX_orig; /**< @brief Location of droplet centroid in x original
                           value given at command line.  */
  const char* centroidX_help; /**< @brief Location of droplet centroid in x help
                                 description.  */
  double centroidY_arg;       /**< @brief Location of droplet centroid in y.  */
  char* centroidY_orig; /**< @brief Location of droplet centroid in y original
                           value given at command line.  */
  const char* centroidY_help; /**< @brief Location of droplet centroid in y help
                                 description.  */
  double referenceZ_arg; /**< @brief Reference z-height of solid surface.  */
  char* referenceZ_orig; /**< @brief Reference z-height of solid surface
                            original value given at command line.  */
  const char* referenceZ_help; /**< @brief Reference z-height of solid surface
                                  help description.  */
  double dropletR_arg;         /**< @brief Droplet radius in angstroms.  */
  char* dropletR_orig; /**< @brief Droplet radius in angstroms original value
                          given at command line.  */
  const char* dropletR_help; /**< @brief Droplet radius in angstroms help
                                description.  */
  double threshDens_arg;     /**< @brief Threshold Density in g/cm^3.  */
  char* threshDens_orig; /**< @brief Threshold Density in g/cm^3 original value
                            given at command line.  */
  const char* threshDens_help; /**< @brief Threshold Density in g/cm^3 help
                                  description.  */
  double bufferLength_arg;     /**< @brief Buffer length in angstroms.  */
  char* bufferLength_orig; /**< @brief Buffer length in angstroms original value
                              given at command line.  */
  const char* bufferLength_help; /**< @brief Buffer length in angstroms help
                                    description.  */
  ...
  const char*
      com_help; /**< @brief selection center of mass help description.  */
  const char* comvel_help; /**< @brief selection center of mass velocity help
                              description.  */
  const char* ca1_help; /**< @brief contact angle of selection (using center of
                           mass) help description.  */
  const char* ca2_help; /**< @brief contact angle of selection (using density
                           profile) help description.  */
  const char*
      gcn_help; /**< @brief Generalized Coordinate Number help description.  */
  const char*
      testequi_help; /**< @brief Temperature using all componets of linear and
                        angular momentum help description.  */
  ...
  unsigned int
      bufferLength_given;      /**< @brief Whether bufferLength was given.  */
  ...
  int sequentialProps_group_counter; /**< @brief Counter for group
                                        sequentialProps */
};
