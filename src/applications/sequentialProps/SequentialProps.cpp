...
int main(int argc, char* argv[]) {
  ...
  if (args_info.com_given) {
    ...
    if (args_info.referenceZ_given)
      ...
      snprintf(painCave.errMsg, MAX_SIM_ERROR_MSG_LENGTH, "--referenceZ must be set if --ca1 is used\n");
      painCave.severity = OPENMD_ERROR;
      painCave.isFatal  = 1;
      simError();
    }
    ...
    if (args_info.dropletR_given)
      ...
      snprintf(painCave.errMsg, MAX_SIM_ERROR_MSG_LENGTH, "--dropletR must be set if --ca1 is used\n");
      painCave.severity = OPENMD_ERROR;
      painCave.isFatal  = 1;
      simError();
    }
    ...
    if (args_info.referenceZ_given)
      ...
      snprintf(painCave.errMsg, MAX_SIM_ERROR_MSG_LENGTH, "--referenceZ must be set if --ca2 is used\n");
      painCave.severity = OPENMD_ERROR;
      painCave.isFatal  = 1;
      simError();
    }
    ...
    if (args_info.centroidX_given)
      ...
      snprintf(painCave.errMsg, MAX_SIM_ERROR_MSG_LENGTH, "--centroidX must be set if --ca2 is used\n");
      painCave.severity = OPENMD_ERROR;
      painCave.isFatal  = 1;
      simError();
    }
    ...
    if (args_info.centroidY_given)
      ...
      snprintf(painCave.errMsg, MAX_SIM_ERROR_MSG_LENGTH, "--centroidY must be set if --ca2 is used\n");
      painCave.severity = OPENMD_ERROR;
      painCave.isFatal  = 1;
      simError();
    }
    ...
    if (args_info.threshDens_given)
      ...
      snprintf(painCave.errMsg, MAX_SIM_ERROR_MSG_LENGTH, "--threshDens must be set if --ca2 is used\n");
      painCave.severity = OPENMD_ERROR;
      painCave.isFatal  = 1;
      simError();
    }
    ...
    if (args_info.bufferLength_given)
      ...
      snprintf(painCave.errMsg, MAX_SIM_ERROR_MSG_LENGTH, "--bufferLength must be set if --ca2 is used\n");
      painCave.severity = OPENMD_ERROR;
      painCave.isFatal  = 1;
      simError();
    }
