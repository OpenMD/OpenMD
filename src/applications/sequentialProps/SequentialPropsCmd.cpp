/*
  ...
  gengetopt --no-handle-error --include-getopt --show-required --unamed-opts --file-name=SequentialPropsCmd --c-extension=cpp --header-extension=hpp
...
const char *gengetopt_args_info_usage = "Usage: SequentialProps [OPTION]... [FILE]...";
...
const char *gengetopt_args_info_help[] = {
  ...
  "      --deltaCount              difference in counts between two selections",
  "      --fluxOut                 number flux out of a selection",
...
cmdline_parser_dump(FILE *outfile, struct gengetopt_args_info *args_info)
{
  ...
  if (args_info->comvel_given)
    write_into_file(outfile, "comvel", 0, 0 );
  if (args_info->deltaCount_given)
    write_into_file(outfile, "deltaCount", 0, 0 );
  if (args_info->fluxOut_given)
    write_into_file(outfile, "fluxOut", 0, 0 );
