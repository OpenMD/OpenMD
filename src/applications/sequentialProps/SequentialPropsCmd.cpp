/*
  ...
  /opt/local/bin/gengetopt -C --input=SequentialProps.ggo --no-handle-error --include-getopt --show-required --unamed-opts --file-name=SequentialPropsCmd --c-extension=cpp --header-extension=hpp
