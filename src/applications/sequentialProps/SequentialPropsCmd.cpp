/*
  ...
  --file-name=SequentialPropsCmd --c-extension=cpp --header-extension=hpp
...
const char *gengetopt_args_info_help[] = {
    ...
    "      --ca1                     contact angle of selection (using center "
    "of\n       "
    "                           mass)",
    "      --ca2                     contact angle of selection (using "
    "density\n         "
    "                         profile)",
    "      --gcn                     Generalized Coordinate Number",
    "  -t, --testequi                Temperature using all componets of linear "
    "and\n     "
    "                             angular momentum",
    0};
...
int cmdline_parser_dump(FILE *outfile, struct gengetopt_args_info *args_info) {
  ...
  if (args_info->com_given) write_into_file(outfile, "com", 0, 0);
  if (args_info->comvel_given) write_into_file(outfile, "comvel", 0, 0);
  if (args_info->ca1_given) write_into_file(outfile, "ca1", 0, 0);
  if (args_info->ca2_given) write_into_file(outfile, "ca2", 0, 0);
  if (args_info->gcn_given) write_into_file(outfile, "gcn", 0, 0);
  if (args_info->testequi_given) write_into_file(outfile, "testequi", 0, 0);
...
int cmdline_parser_required2(struct gengetopt_args_info *args_info,
  ...
  if (args_info->sequentialProps_group_counter == 0) {
    fprintf(stderr,
            "%s: %d options of group sequentialProps were given. One is "
            "required%s.\n",
            prog_name, args_info->sequentialProps_group_counter,
            (additional_error ? additional_error : ""));
    error_occurred = 1;
  }
...
int cmdline_parser_internal(int argc, char **argv,
  ...
  while (1) {
    ...
    static struct option long_options[] = {
        ...
        {"sele1", 1, NULL, 0},        {"sele2", 1, NULL, 0},
        {"nbins", 1, NULL, 'b'},      {"nbins_z", 1, NULL, 0},
        {"centroidX", 1, NULL, 'x'},  {"centroidY", 1, NULL, 'y'},
        {"referenceZ", 1, NULL, 'z'}, {"dropletR", 1, NULL, 'r'},
        {"threshDens", 1, NULL, 0},   {"bufferLength", 1, NULL, 0},
        {"rcut", 1, NULL, 0},         {"com", 0, NULL, 'c'},
        {"comvel", 0, NULL, 'v'},     {"ca1", 0, NULL, 0},
        {"ca2", 0, NULL, 0},          {"gcn", 0, NULL, 0},
        {"testequi", 0, NULL, 't'},   {0, 0, 0, 0}};
    ...
    c = custom_getopt_long(argc, argv, "hVi:o:b:x:y:z:r:cvt", long_options,
                           &option_index);
  ...
  if (args_info->sequentialProps_group_counter > 1) {
    fprintf(stderr,
            "%s: %d options of group sequentialProps were given. One is "
            "required%s.\n",
            argv[0], args_info->sequentialProps_group_counter,
            (additional_error ? additional_error : ""));
    error_occurred = 1;
  }
