/*
  ...
  gengetopt --no-handle-error --include-getopt --show-required --unamed-opts --file-name=HydroCmd --c-extension=cpp --header-extension=hpp
...
const char *cmdline_parser_model_values[] = {"AtomicBead", "RoughShell", "BoundaryElement", 0}; /*< Possible values for model. */
...
void init_args_info(struct gengetopt_args_info *args_info)
{
  ...
  args_info->xyz_help = gengetopt_args_info_help[4] ;
  args_info->stl_help = gengetopt_args_info_help[5] ;
  args_info->msms_help = gengetopt_args_info_help[6] ;
...
cmdline_parser_release (struct gengetopt_args_info *args_info)
{
  ...
  free_string_field (&(args_info->viscosity_orig));
...
cmdline_parser_dump(FILE *outfile, struct gengetopt_args_info *args_info)
{
  ...
  if (args_info->xyz_given)
    write_into_file(outfile, "xyz", args_info->xyz_orig, 0);
  if (args_info->stl_given)
    write_into_file(outfile, "stl", args_info->stl_orig, 0);
  if (args_info->msms_given)
    write_into_file(outfile, "msms", args_info->msms_orig, 0);
