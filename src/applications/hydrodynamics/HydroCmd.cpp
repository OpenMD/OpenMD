...
const char *cmdline_parser_model_values[] = {"BeadModel", "RoughShell", 0}; /*< Possible values for model. */
  ...
  while (1)
    {
      ...
      c = custom_getopt_long (argc, argv, "hVi:o:s:b", long_options, &option_index);
