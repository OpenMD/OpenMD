/*
  ...
  /opt/local/bin/gengetopt -C --input=Hydro.ggo --no-handle-error --include-getopt --show-required --unamed-opts --file-name=HydroCmd --c-extension=cpp --header-extension=hpp
  ...
  while (1)
    {
      ...
      c = custom_getopt_long (argc, argv, "hVi:o:b", long_options, &option_index);
