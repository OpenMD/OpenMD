/*
  ...
  --file-name=HydroCmd --c-extension=cpp --header-extension=hpp
...
const char* gengetopt_args_info_purpose =
    ...
    "the "
    "Langevin integrator using complex rigid bodies. Hydro\nsupports two "
    "approximate "
    "models: the BeadModel and\nRoughShell. Additionally, Hydro can generate "
    "resistance "
    "tensor files\nusing analytic solutions for simple shapes. To generate a "
    ".hydro "
    "file,\na metadata file is needed as the input file. Since the "
    "resistance\ntensor "
    "depends on these quantities, the viscosity of the solvent and\nthe "
    "temperature "
    "(targetTemp) of the system must be defined in\nmeta-data file. If the "
    "approximate "
    "model in use is the RoughShell\nmodel the beadSize (the diameter of the "
    "small beads "
...
const char* gengetopt_args_info_help[] = {
    ...
    "angstroms)\n "
    "                          (default=`0.2')",
    "  -b, --beads            generate the beads only, hydrodynamics will not "
    "be\n       "
...
const char* cmdline_parser_model_values[] = {
    "BeadModel", "RoughShell", 0}; /*< Possible values for model. */
...
static void clear_args(struct gengetopt_args_info* args_info) {
  ...
  args_info->model_arg     = model_arg_RoughShell;
...
int cmdline_parser_dump(FILE* outfile, struct gengetopt_args_info* args_info) {
  ...
  if (args_info->model_given)
    write_into_file(outfile, "model", args_info->model_orig,
                    cmdline_parser_model_values);
  if (args_info->beadSize_given)
    write_into_file(outfile, "beadSize", args_info->beadSize_orig, 0);
  if (args_info->beads_given) write_into_file(outfile, "beads", 0, 0);
...
int cmdline_parser_internal(int argc, char** argv,
  ...
  while (1) {
    ...
    static struct option long_options[] = {
        ...
        {"model", 1, NULL, 0},   {"beadSize", 1, NULL, 's'},
        {"beads", 0, NULL, 'b'}, {0, 0, 0, 0}};
    ...
    c = custom_getopt_long(argc, argv, "hVi:o:s:b", long_options,
                           &option_index);
    ...
    case 'o': /* output file prefix.  */
      ...
      if (update_arg((void*)&(args_info->output_arg), &(args_info->output_orig),
                     ...
                     &(local_args_info.output_given), optarg, 0, "hydro",
                     ARG_STRING, check_ambiguity, override, 0, 0, "output", 'o',
                     additional_error))
        goto failure;
    ...
    case 's': /* bead size for RoughShell model (in angstroms).  */
      ...
      if (update_arg((void*)&(args_info->beadSize_arg),
                     ...
                     &(local_args_info.beadSize_given), optarg, 0, "0.2",
                     ARG_DOUBLE, check_ambiguity, override, 0, 0, "beadSize",
                     's', additional_error))
        goto failure;
    ...
    case 'b': /* generate the beads only, hydrodynamics will not be performed.
      ...
      if (update_arg((void*)&(args_info->beads_flag), 0,
                     &(args_info->beads_given), &(local_args_info.beads_given),
                     optarg, 0, 0, ARG_FLAG, check_ambiguity, override, 1, 0,
                     "beads", 'b', additional_error))
        goto failure;
    ...
    case 0: /* Long option with no short option */
      ...
      if (strcmp(long_options[option_index].name, "model") == 0) {
        if (update_arg((void*)&(args_info->model_arg), &(args_info->model_orig),
                       &(args_info->model_given),
                       &(local_args_info.model_given), optarg,
                       cmdline_parser_model_values, "RoughShell", ARG_ENUM,
                       check_ambiguity, override, 0, 0, "model", '-',
                       additional_error))
          goto failure;
      }
