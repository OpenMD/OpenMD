...
#define CMDLINE_PARSER_PACKAGE_NAME "thermalizer"
#endif
...
struct gengetopt_args_info {
  ...
  char* temperature_orig;  /**< @brief temperature (K) original value given at
                              command line.  */
  const char*
      temperature_help;    /**< @brief temperature (K) help description.  */
  double energy_arg;       /**< @brief energy (kcal/mol).  */
  char* energy_orig;       /**< @brief energy (kcal/mol) original value given at
                              command line.  */
  const char* energy_help; /**< @brief energy (kcal/mol) help description.  */
  double chargetemperature_arg; /**< @brief charge temperature (K).  */
  char* chargetemperature_orig; /**< @brief charge temperature (K) original
                                   value given at command line.  */
  const char* chargetemperature_help; /**< @brief charge temperature (K) help
                                         description.  */
  ...
  unsigned int chargetemperature_given; /**< @brief Whether chargetemperature
                                           was given.  */
