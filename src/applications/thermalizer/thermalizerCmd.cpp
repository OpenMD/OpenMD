/*
  ...
  /opt/local/bin/gengetopt -C --input=thermalizer.ggo --include-getopt --show-required --unamed-opts --file-name=thermalizerCmd --c-extension=cpp --header-extension=hpp --no-handle-error  --include-getopt --long-help --show-required --unamed-opts --file-name=thermalizerCmd --c-extension=cpp --header-extension=hpp
...
void init_args_info(struct gengetopt_args_info *args_info)
{
  ...
  args_info->temperature_help = gengetopt_args_info_help[4] ;
  args_info->energy_help = gengetopt_args_info_help[5] ;
...
static void
reset_group_thermalizer(struct gengetopt_args_info *args_info)
{
  if (! args_info->thermalizer_group_counter)
    return;
  ...
  while (1)
    {
      ...
      c = custom_getopt_long (argc, argv, "hVo:t:e:", long_options, &option_index);
