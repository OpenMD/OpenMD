/*
  ...
  /opt/local/bin/gengetopt -C --input=thermalizer.ggo --no-handle-error --include-getopt --show-required --unamed-opts --file-name=thermalizerCmd --c-extension=cpp --header-extension=hpp
