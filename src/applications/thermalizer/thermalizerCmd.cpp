  ...
  while (1) {
    ...
    switch (c) {
      ...
      case 'e': /* energy (kcal/mol).  */
        ...
        if (update_arg((void *)&(args_info->energy_arg),
                       &(args_info->energy_orig), &(args_info->energy_given),
                       &(local_args_info.energy_given), optarg, 0, 0,
                       ARG_DOUBLE, check_ambiguity, override, 0, 0, "energy",
                       'e', additional_error))
          goto failure;
