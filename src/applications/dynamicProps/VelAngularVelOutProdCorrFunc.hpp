...
#ifndef APPLICATIONS_DYNAMICPROPS_VELANGULARVELOUTPRODCORRFUNC_HPP
#define APPLICATIONS_DYNAMICPROPS_VELANGULARVELOUTPRODCORRFUNC_HPP

#include "applications/dynamicProps/TimeCorrFunc.hpp"

namespace OpenMD {

  class VelAngularVelOutProdCorrFunc : public ObjectCCF<Mat3x3d> {
  public:
    VelAngularVelOutProdCorrFunc(SimInfo* info, const std::string& filename,
