/*
  ...
  /opt/local/bin/gengetopt -C --input=DynamicProps.ggo --no-handle-error --include-getopt --show-required --unamed-opts --file-name=DynamicPropsCmd --c-extension=cpp --header-extension=hpp
