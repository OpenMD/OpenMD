...
void init_args_info(struct gengetopt_args_info *args_info)
{
  ...
  args_info->selecorr_help = gengetopt_args_info_help[14] ;
  args_info->rcorr_help = gengetopt_args_info_help[15] ;
  args_info->rcorrZ_help = gengetopt_args_info_help[16] ;
  args_info->vcorr_help = gengetopt_args_info_help[17] ;
  args_info->vcorrZ_help = gengetopt_args_info_help[18] ;
  args_info->vcorrR_help = gengetopt_args_info_help[19] ;
  args_info->dcorr_help = gengetopt_args_info_help[20] ;
  args_info->lcorr_help = gengetopt_args_info_help[21] ;
  args_info->lcorrZ_help = gengetopt_args_info_help[22] ;
  args_info->cohZ_help = gengetopt_args_info_help[23] ;
  args_info->sdcorr_help = gengetopt_args_info_help[24] ;
  args_info->r_rcorr_help = gengetopt_args_info_help[25] ;
  args_info->thetacorr_help = gengetopt_args_info_help[26] ;
  args_info->drcorr_help = gengetopt_args_info_help[27] ;
  args_info->helfandEcorr_help = gengetopt_args_info_help[28] ;
  args_info->momentum_help = gengetopt_args_info_help[29] ;
  args_info->stresscorr_help = gengetopt_args_info_help[30] ;
