/*
  ...
  --file-name=DynamicPropsCmd --c-extension=cpp --header-extension=hpp
...
const char *gengetopt_args_info_purpose =
    ...
    "square "
    "displacement and the\nvelocity autocorrelation functions. The selection "
    "syntax can "
    "be used\nto specify the StuntDoubles that will be used for the "
    "calculation. "
    "A\ngeneral time correlation function can be thought of as:\n\n           "
    "C(t) =  < "
    "A(0) * B(t) >\n\nwhere A(t) and B(t) are time-dependent properties, and "
    "the < "
    ">\nindicates an average over the initial time and atoms (if A and B "
    "are\nproperties "
    "of atoms).\n\nExample:\n  DynamicProps -i longRun.dump  --rcorr "
    "--sele1=\"select "
    "SPCE_RB_0\"";
...
const char *gengetopt_args_info_help[] = {
    ...
    "      --sele2=selection script  select second stuntdouble set (if sele2 "
    "is not\n    "
    ...
    "      --lcorrZ                  Lengendre correlation function binned by "
    "Z",
    "      --cohZ                    Lengendre correlation function for OH "
    "bond\n        "
    "                          vectors binned by Z",
    "  -M, --sdcorr                  System dipole correlation function",
    "      --r_rcorr                 Radial msd",
    "      --thetacorr               Angular msd [Cos(theta)]",
    "      --drcorr                  Directional msd for particles with unit "
    "vectors",
    "      --stresscorr              Stress tensor correlation function",
    "  -b, --bondcorr                Bond extension correlation function",
    "  -f, --freqfluccorr            Frequency Fluctuation correlation "
    "function",
    "  -j, --jumptime                Hydrogen bond jump time correlation "
    "function",
    "      --jumptimeZ               Hydrogen bond jump time correlation "
    "function\n      "
    "                            binned by Z",
    "      --persistence             Hydrogen bond persistence correlation "
    "function",
    "      --pjcorr                  Momentum - Angular Momentum cross "
    "correlation\n     "
    "                             function",
    "      --ftcorr                  Force - Torque cross correlation function",
    "      --ckcorr                  Charge - Kinetic energy cross "
    "correlation\n         "
    "                         function",
    ...
    "      --dispZ                   Displacement correlation function binned "
    "by Z",
...
int cmdline_parser_dump(FILE *outfile, struct gengetopt_args_info *args_info) {
  ...
  if (args_info->selecorr_given) write_into_file(outfile, "selecorr", 0, 0);
  if (args_info->rcorr_given) write_into_file(outfile, "rcorr", 0, 0);
  if (args_info->rcorrZ_given) write_into_file(outfile, "rcorrZ", 0, 0);
  if (args_info->vcorr_given) write_into_file(outfile, "vcorr", 0, 0);
  if (args_info->vcorrZ_given) write_into_file(outfile, "vcorrZ", 0, 0);
  if (args_info->vcorrR_given) write_into_file(outfile, "vcorrR", 0, 0);
  if (args_info->wcorr_given) write_into_file(outfile, "wcorr", 0, 0);
  if (args_info->dcorr_given) write_into_file(outfile, "dcorr", 0, 0);
  if (args_info->lcorr_given) write_into_file(outfile, "lcorr", 0, 0);
  if (args_info->lcorrZ_given) write_into_file(outfile, "lcorrZ", 0, 0);
  if (args_info->cohZ_given) write_into_file(outfile, "cohZ", 0, 0);
  if (args_info->sdcorr_given) write_into_file(outfile, "sdcorr", 0, 0);
  if (args_info->r_rcorr_given) write_into_file(outfile, "r_rcorr", 0, 0);
  if (args_info->thetacorr_given) write_into_file(outfile, "thetacorr", 0, 0);
  if (args_info->drcorr_given) write_into_file(outfile, "drcorr", 0, 0);
  if (args_info->stresscorr_given) write_into_file(outfile, "stresscorr", 0, 0);
  if (args_info->bondcorr_given) write_into_file(outfile, "bondcorr", 0, 0);
  if (args_info->freqfluccorr_given)
    write_into_file(outfile, "freqfluccorr", 0, 0);
  if (args_info->jumptime_given) write_into_file(outfile, "jumptime", 0, 0);
  if (args_info->jumptimeZ_given) write_into_file(outfile, "jumptimeZ", 0, 0);
  if (args_info->persistence_given)
    write_into_file(outfile, "persistence", 0, 0);
  if (args_info->pjcorr_given) write_into_file(outfile, "pjcorr", 0, 0);
  if (args_info->ftcorr_given) write_into_file(outfile, "ftcorr", 0, 0);
  if (args_info->ckcorr_given) write_into_file(outfile, "ckcorr", 0, 0);
  if (args_info->cscorr_given) write_into_file(outfile, "cscorr", 0, 0);
  if (args_info->facorr_given) write_into_file(outfile, "facorr", 0, 0);
  if (args_info->tfcorr_given) write_into_file(outfile, "tfcorr", 0, 0);
  if (args_info->tacorr_given) write_into_file(outfile, "tacorr", 0, 0);
  if (args_info->disp_given) write_into_file(outfile, "disp", 0, 0);
  if (args_info->dispZ_given) write_into_file(outfile, "dispZ", 0, 0);
  if (args_info->current_given) write_into_file(outfile, "current", 0, 0);
  if (args_info->ddisp_given) write_into_file(outfile, "ddisp", 0, 0);
...
int cmdline_parser_required2(struct gengetopt_args_info *args_info,
  ...
  if (args_info->correlation_function_group_counter == 0) {
    fprintf(stderr,
            "%s: %d options of group correlation function were given. One is "
            "required%s.\n",
            prog_name, args_info->correlation_function_group_counter,
            (additional_error ? additional_error : ""));
    error_occurred = 1;
  }
...
int cmdline_parser_internal(int argc, char **argv,
  ...
  while (1) {
    ...
    c = custom_getopt_long(argc, argv, "hVi:o:z:c:srvwdlMbfj", long_options,
                           &option_index);
  ...
  if (args_info->correlation_function_group_counter > 1) {
    fprintf(stderr,
            "%s: %d options of group correlation function were given. One is "
            "required%s.\n",
            argv[0], args_info->correlation_function_group_counter,
            (additional_error ? additional_error : ""));
    error_occurred = 1;
  }
