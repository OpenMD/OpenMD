 ...
 */
#ifndef APPLICATIONS_DYNAMICPROPS_TEMPLATEDMULTIPASSCORRFUNC_HPP
#define APPLICATIONS_DYNAMICPROPS_TEMPLATEDMULTIPASSCORRFUNC_HPP
...
namespace OpenMD {
  ...
  public:
    ...
    virtual ~templatedMultipassCorrFunc(){ }
