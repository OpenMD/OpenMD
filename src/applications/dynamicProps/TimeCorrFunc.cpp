...
TimeCorrFunc<T>::TimeCorrFunc(SimInfo* info, const string& filename,
    ...
    : storageLayout_(storageLayout),
      ...
      evaluator2_(info_),
      autoCorrFunc_(false),
      doSystemProperties_(false),
      doMolecularProperties_(false),
...
// it is necessary to keep the constructor definitions here or the code wont be
// generated and linking issues will occur. Blame templating
template <typename T>
