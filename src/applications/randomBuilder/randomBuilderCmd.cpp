/*
  ...
  /opt/local/bin/gengetopt -C --input=randomBuilder.ggo --no-handle-error --include-getopt --show-required --unamed-opts --file-name=randomBuilderCmd --c-extension=cpp --header-extension=hpp
