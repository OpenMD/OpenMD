...
struct gengetopt_args_info {
  ...
  char* density_orig;       /**< @brief density (g/cm^3) original value given at
                               command line.  */
  const char* density_help; /**< @brief density (g/cm^3) help description.  */
  int nx_arg;               /**< @brief number of unit cells in x.  */
  char* nx_orig; /**< @brief number of unit cells in x original value given at
                    command line.  */
  const char*
      nx_help;   /**< @brief number of unit cells in x help description.  */
  int ny_arg;    /**< @brief number of unit cells in y.  */
  char* ny_orig; /**< @brief number of unit cells in y original value given at
                    command line.  */
  const char*
      ny_help;   /**< @brief number of unit cells in y help description.  */
  int nz_arg;    /**< @brief number of unit cells in z.  */
  char* nz_orig; /**< @brief number of unit cells in z original value given at
                    command line.  */
  const char*
      nz_help; /**< @brief number of unit cells in z help description.  */
  double* molFraction_arg; /**< @brief (Default) Builds a multi-component random
                              mixed nanoparticle. Mole Fraction must be
                              specified for each componet > 1 in MD file..  */
  char** molFraction_orig; /**< @brief (Default) Builds a multi-component random
                              mixed nanoparticle. Mole Fraction must be
                              specified for each componet > 1 in MD file.
                              original value given at command line.  */
  unsigned int molFraction_min; /**< @brief (Default) Builds a multi-component
                                   random mixed nanoparticle. Mole Fraction must
                                   be specified for each componet > 1 in MD
                                   file.'s minimum occurreces */
  unsigned int molFraction_max; /**< @brief (Default) Builds a multi-component
                                   random mixed nanoparticle. Mole Fraction must
                                   be specified for each componet > 1 in MD
                                   file.'s maximum occurreces */
  const char* molFraction_help; /**< @brief (Default) Builds a multi-component
                                   random mixed nanoparticle. Mole Fraction must
                                   be specified for each componet > 1 in MD
