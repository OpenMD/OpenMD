...
Globals::Globals() {
  ...
  DefineOptionalParameter(UseSurfaceTerm, "useSlabGeometry");
  DefineOptionalParameterWithDefaultValue(Dielectric, "dielectric", 80.0);
  DefineOptionalParameterWithDefaultValue(CompressDumpFile, "compressDumpFile",
                                          false);
  ...
  DefineOptionalParameterWithDefaultValue(
      ...
      "TIME|TOTAL_ENERGY|POTENTIAL_ENERGY|KINETIC_ENERGY|TEMPERATURE|PRESSURE|"
      "VOLUME|"
      "CONSERVED_QUANTITY");
  DefineOptionalParameterWithDefaultValue(StatFilePrecision,
                                          "statFilePrecision", 8);
  DefineOptionalParameterWithDefaultValue(
      UseSphericalBoundaryConditions, "useSphericalBoundaryConditions", false);
  ...
  DefineOptionalParameterWithDefaultValue(UseThermodynamicIntegration,
                                          "useThermodynamicIntegration", false);
