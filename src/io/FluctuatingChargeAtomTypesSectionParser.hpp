...
#ifndef IO_FLUCTUATINGCHARGEATOMTYPESSECTIONPARSER_HPP
#define IO_FLUCTUATINGCHARGEATOMTYPESSECTIONPARSER_HPP
...
namespace OpenMD {
  ...
  class FluctuatingChargeAtomTypesSectionParser : public SectionParser {
  public:
