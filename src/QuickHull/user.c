/*<html><pre>  -<a                             href="qh-user.htm"
  >-------------------------------</a><a name="TOP">-</a>
   ...
   see user.h for user-definable constants
      ...
      please use qh_NOmem in mem.h to turn off memory management
      please use qh_NOmerge in user.h to turn off facet merging
...
#if 0
{
  ...
  FILE *outfile= stdout;    /* output from qh_produce_output()
			       please use NULL to skip qh_produce_output() */
