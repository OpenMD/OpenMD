...
/*-<a                             href="qh-geom.htm#TOC"
  ...
  ALGORITHMfault   use as argument to checkconvex() to report errors during buildhull
*/
...
/*-<a                             href="qh-poly.htm#TOC"
  ...
  DATAfault        use as argument to checkconvex() to report errors during initialhull
*/
