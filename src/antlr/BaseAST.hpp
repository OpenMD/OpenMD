...
namespace antlr {
  ...
  public:
    BaseAST() : AST() {}
    BaseAST(const BaseAST& other) : AST(other) {}
    virtual ~BaseAST() {}
    ...
    virtual RefAST getFirstChild() const { return RefAST(down); }
    /// Get  the next sibling in line after this one
    virtual RefAST getNextSibling() const { return RefAST(right); }

    /// Get the token text for this node
    virtual ANTLR_USE_NAMESPACE(std) string getText() const { return ""; }
