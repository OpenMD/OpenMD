...
namespace antlr {
  ...
  public:
    ...
    ANTLRException(const ANTLR_USE_NAMESPACE(std) string& s) : text(s) {}
     ...
     */
    virtual ANTLR_USE_NAMESPACE(std) string toString() const { return text; }
     ...
     * from here.
     */
    virtual ANTLR_USE_NAMESPACE(std) string getMessage() const { return text; }
