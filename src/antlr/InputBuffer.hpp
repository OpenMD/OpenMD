...
namespace antlr {
  ...
  public:
    ...
    InputBuffer() : nMarkers(0), markerOffset(0), numToConsume(0) {}
     ...
     * rewinding the input.
     */
    inline void commit(void) { nMarkers--; }

    /** Mark another character for deferred consumption */
    virtual inline void consume() { numToConsume++; }
    ...
    virtual inline bool isMarked() const { return (nMarkers != 0); }
