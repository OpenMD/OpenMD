...
namespace antlr {
   ...
   * This super factory maintains a map of all AST node types to their
   * respective AST factories. One instance should be shared among a
   * parser/treeparser chain.
   *
  ...
  public:
    ...
    RefAST create(const ANTLR_USE_NAMESPACE(std) string& txt,
