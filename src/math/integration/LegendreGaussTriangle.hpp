...
namespace OpenMD {
  ...
  struct LegendreGaussTriangleParams :
      public LegendreGaussTriangle<RealType, RealType> {
  public:
    LegendreGaussTriangleParams(size_t points) :
        LegendreGaussTriangleParams<RealType, RealType>(points) {};
  ...
  template<class returnType, class argumentType>
  returnType LegendreGaussTriangle<returnType, argumentType>::integral(
