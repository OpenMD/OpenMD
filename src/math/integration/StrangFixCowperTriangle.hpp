...
namespace OpenMD {
  ...
  struct StrangFixCowperTriangleParams :
      public StrangFixCowperTriangle<RealType, RealType> {
  public:
    StrangFixCowperTriangleParams(size_t points) :
        StrangFixCowperTriangleParams<RealType, RealType>(points) {};
  ...
  template<class returnType, class argumentType>
  StrangFixCowperTriangle<returnType,
                          argumentType>::~StrangFixCowperTriangle() {
    xi.clear();
    xi.shrink_to_fit();
    w.clear();
    w.shrink_to_fit();
  ...
  template<class returnType, class argumentType>
  returnType StrangFixCowperTriangle<returnType, argumentType>::integral(
      const argumentType& r0, const argumentType& r1, const argumentType& r2,
      RealType area) const {
