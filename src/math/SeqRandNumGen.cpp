...
SeqRandNumGen::SeqRandNumGen(const uint32& oneSeed) {
  // In order to generate independent random number stream, the actual seed used
  // by random number generator is the seed passed to the constructor plus the
  // number of random number generators which are already created.
