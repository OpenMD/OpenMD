...
namespace OpenMD {
  ...
  ForceDecomposition::ForceDecomposition(SimInfo* info,
    ...
    cellOffsets_.clear();
    cellOffsets_.push_back(Vector3pdt( 0,  0,  0));
    cellOffsets_.push_back(Vector3pdt( 1,  0,  0));
    cellOffsets_.push_back(Vector3pdt( 1,  1,  0));
    cellOffsets_.push_back(Vector3pdt( 0,  1,  0));
    cellOffsets_.push_back(Vector3pdt(-1,  1,  0));
    cellOffsets_.push_back(Vector3pdt( 0,  0,  1));
    cellOffsets_.push_back(Vector3pdt( 1,  0,  1));
    cellOffsets_.push_back(Vector3pdt( 1,  1,  1));
    cellOffsets_.push_back(Vector3pdt( 0,  1,  1));
    cellOffsets_.push_back(Vector3pdt(-1,  1,  1));
    cellOffsets_.push_back(Vector3pdt(-1,  0,  1));
    cellOffsets_.push_back(Vector3pdt(-1, -1,  1));
    cellOffsets_.push_back(Vector3pdt( 0, -1,  1));
