...
SimInfo::SimInfo(ForceField* ff, Globals* simParams)
    : forceField_(ff),
      ...
      nInversions_(0),
      nRigidBodies_(0),
      nIntegrableObjects_(0),
      nCutoffGroups_(0),
      nConstraints_(0),
      nFluctuatingCharges_(0),
      nGlobalMols_(0),
      nGlobalAtoms_(0),
      nGlobalCutoffGroups_(0),
      nGlobalIntegrableObjects_(0),
      nGlobalRigidBodies_(0),
      nGlobalFluctuatingCharges_(0),
      nGlobalBonds_(0),
      nGlobalBends_(0),
      nGlobalTorsions_(0),
      nGlobalInversions_(0),
      nGlobalConstraints_(0),
...
set<AtomType*> SimInfo::getSimulatedAtomTypes() {
  ...
  MPI_Allgatherv(&foundTypes[0], count_local, MPI_INT, &ftGlobal[0], &counts[0],
                 &disps[0], MPI_INT, MPI_COMM_WORLD);
  ...
  for (j = ftGlobal.begin(); j != ftGlobal.end(); ++j) foundIdents.insert((*j));
