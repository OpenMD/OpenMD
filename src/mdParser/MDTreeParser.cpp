...
#line 702 "MDTreeParser.cpp"
				...
				if ( _cnt126>=1 ) { goto _loop126; } else {throw ANTLR_USE_NAMESPACE(antlr)NoViableAltException(_t);}
			}
...
#line 1626 "MDTreeParser.cpp"
		...
		case UREYBRADLEY:
		{
			...
			_t = __t70;
			_t = _t->getNextSibling();
#line 200 "MDTreeParser.g"
			currBendStamp->overrideType("UreyBradley", dvec);
#line 1641 "MDTreeParser.cpp"
			break;
		}
		case CUBIC:
		{
...
const unsigned long MDTreeParser::_tokenSet_0_data_[] = { 125829360UL, 32768UL, 0UL, 0UL };
// "component" "molecule" "zconstraint" "restraint" "flucQ" "RNEMD" "minimizer" 
// "analyzer" ASSIGNEQUAL 
const ANTLR_USE_NAMESPACE(antlr)BitSet MDTreeParser::_tokenSet_0(_tokenSet_0_data_,4);
const unsigned long MDTreeParser::_tokenSet_1_data_[] = { 196352UL, 32768UL, 0UL, 0UL };
...
const unsigned long MDTreeParser::_tokenSet_2_data_[] = { 6291456UL, 36864UL, 0UL, 0UL };
...
const unsigned long MDTreeParser::_tokenSet_3_data_[] = { 4161011712UL, 32769UL, 0UL, 0UL };
...
const unsigned long MDTreeParser::_tokenSet_4_data_[] = { 4026793984UL, 32782UL, 0UL, 0UL };
...
const unsigned long MDTreeParser::_tokenSet_5_data_[] = { 4026793984UL, 33008UL, 0UL, 0UL };
...
const unsigned long MDTreeParser::_tokenSet_6_data_[] = { 270008320UL, 36608UL, 0UL, 0UL };
