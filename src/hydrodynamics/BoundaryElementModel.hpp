...
#ifndef HYDRODYNAMICS_BOUNDARYELEMENTMODEL_HPP
#define HYDRODYNAMICS_BOUNDARYELEMENTMODEL_HPP
...
namespace OpenMD {
  ...
  class BoundaryElementModel : public ApproximateModel {
  public:
