...
CPPUNIT_TEST_SUITE_REGISTRATION( OOPSERandNumGenTestCase );

using namespace oopse;

void OOPSERandNumGenTestCase::testUniform(){
    OOPSERandNumGen randNumGen(823645754);
...
void OOPSERandNumGenTestCase::testGaussian(){      
    OOPSERandNumGen randNumGen(823645754);
    double mean = 3.0;
    double variance = 1.0;
    const int num = 1000000;
...
void OOPSERandNumGenTestCase::testMPIRNG(){      
#ifdef IS_MPI
    const int seed = 324271632;
    const int nloops = 1000000;
    MPI_Status istatus;
    OOPSERandNumGen mpiRandNumGen(seed);
